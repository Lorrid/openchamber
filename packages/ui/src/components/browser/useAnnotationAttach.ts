...
export const useAnnotationOverlayLabels = (): BrowserAnnotationOverlayLabels => {
  ...
  return React.useMemo(() => ({
    ...
    styles: t('contextPanel.browser.annotate.tool.styles'),
    commentPlaceholder: t('contextPanel.browser.annotate.commentPlaceholder'),
    submit: t('contextPanel.browser.annotate.submit'),
    cancel: t('contextPanel.browser.annotate.cancel'),
    clear: t('contextPanel.browser.annotate.clear'),
    text: t('contextPanel.browser.annotate.group.text'),
    colors: t('contextPanel.browser.annotate.group.colors'),
    borders: t('contextPanel.browser.annotate.group.borders'),
    sizing: t('contextPanel.browser.annotate.group.sizing'),
    fontSize: t('contextPanel.browser.annotate.field.fontSize'),
    fontWeight: t('contextPanel.browser.annotate.field.fontWeight'),
    textColor: t('contextPanel.browser.annotate.field.textColor'),
    background: t('contextPanel.browser.annotate.field.background'),
    borderColor: t('contextPanel.browser.annotate.field.borderColor'),
    borderWidth: t('contextPanel.browser.annotate.field.borderWidth'),
    borderRadius: t('contextPanel.browser.annotate.field.borderRadius'),
    width: t('contextPanel.browser.annotate.field.width'),
    height: t('contextPanel.browser.annotate.field.height'),
    opacity: t('contextPanel.browser.annotate.field.opacity'),
  }), [t]);
};
