                  ...
                  {(addDeviceTransport === 'relay' || (addDeviceTransport === 'lan' && addDeviceFallback)) ? (
                    <label className="block space-y-1.5 pt-2">
                      ...
                      <Input
                        ...
                        onChange={(event) => setAddDeviceRelayUrl(event.target.value)}
                        placeholder={DEFAULT_PAIRING_RELAY_URL}
                        disabled={transportOptions?.relayUrlLocked === true}
                        spellCheck={false}
                        autoCapitalize="none"
                        autoCorrect="off"
                      />
                      <span className="block typography-meta text-muted-foreground">
