...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.usage.sidebar.activeTotal': '{count}개 활성',
  'settings.usage.sidebar.overview': '개요',
  'settings.usage.sidebar.activeProviders': '활성 프로바이더',
  'settings.usage.sidebar.addProvider': '프로바이더 추가',
  'settings.usage.sidebar.availableCount': '{count}개 사용 가능',
  'settings.usage.sidebar.removeProviderAria': '사용량에서 {provider} 제거',
  'settings.usage.sidebar.removeProviderTitle': '사용량에서 제거',
  'settings.usage.sidebar.remainingPct': '{percent}% 남음',
  'settings.usage.sidebar.usedPct': '{percent}% 사용',
  ...
  'settings.usage.overview.title': '사용량 개요',
  'settings.usage.overview.description': '모든 프로바이더의 LLM 사용량과 비용을 모니터링합니다.',
  'settings.usage.overview.period.aria': '사용 기간',
  'settings.usage.overview.period.7d': '7일',
  'settings.usage.overview.period.30d': '30일',
  'settings.usage.overview.metric.totalSpend': '총 지출',
  'settings.usage.overview.metric.totalTokens': '총 토큰',
  'settings.usage.overview.metric.requests': '요청',
  'settings.usage.overview.metric.avgCost': '평균 비용 / 1K 토큰',
  'settings.usage.overview.chart.usageOverTime': '시간별 사용량',
  'settings.usage.overview.chart.topProviders': '지출 상위 프로바이더',
  'settings.usage.overview.chart.metricAria': '차트 지표',
  'settings.usage.overview.chart.metric.tokens': '토큰',
  'settings.usage.overview.chart.metric.cost': '비용',
  'settings.usage.overview.chart.metric.requests': '요청',
  'settings.usage.overview.chart.empty': '이 기간에 세션 사용량이 아직 없습니다.',
  'settings.usage.overview.providers.title': '프로바이더',
  'settings.usage.overview.providers.col.provider': '프로바이더',
  'settings.usage.overview.providers.col.spend': '지출',
  'settings.usage.overview.providers.col.tokens': '토큰',
  'settings.usage.overview.providers.col.requests': '요청',
  'settings.usage.overview.providers.col.remaining': '남음 / 한도',
  'settings.usage.overview.providers.col.status': '상태',
  'settings.usage.overview.providers.remainingPct': '{percent}% 남음',
  'settings.usage.overview.providers.status.active': '활성',
  'settings.usage.overview.providers.status.error': '오류',
  'settings.usage.overview.providers.openDetailAria': '{provider} 사용량 세부정보 열기',
  'settings.usage.overview.providers.removeAria': '사용량에서 {provider} 제거',
  'settings.usage.overview.empty.title': '사용량에 프로바이더가 아직 없습니다',
  'settings.usage.overview.empty.description': '구성된 프로바이더는 여기에 자동으로 표시됩니다. 프로바이더를 추가하거나 제거한 항목을 복원하세요.',
  'settings.usage.overview.actions.title': '빠른 작업',
  'settings.usage.overview.actions.addProvider': '프로바이더 추가',
  'settings.usage.overview.actions.addProviderDescription': '새 LLM 프로바이더 연결',
  'settings.usage.overview.actions.manageLimits': '한도 관리',
  'settings.usage.overview.actions.manageLimitsDescription': '남은 할당량과 한도 검토',
  'settings.usage.overview.available.title': '사용 가능한 프로바이더',
  'settings.usage.overview.available.description': '연결할 수 있거나, 제거 후 사용량 블록에 복원할 수 있는 프로바이더입니다.',
  'settings.usage.overview.available.hiddenConfigured': '구성됨 — 사용량에서 제거됨',
  'settings.usage.overview.available.notConfigured': '아직 연결되지 않음',
  'settings.usage.overview.available.restore': '복원',
  'settings.usage.overview.available.connect': '연결',
  'settings.usage.add.title': '프로바이더 추가',
  'settings.usage.add.description': '사용 가능한 프로바이더에서 선택하세요: 새로 연결하거나, 사용량에서 제거한 구성된 프로바이더를 복원합니다.',
  'settings.usage.add.backAria': '사용량 개요로 돌아가기',
  'settings.usage.add.empty': '지원되는 모든 프로바이더가 이미 사용량에 표시되어 있습니다.',
  'settings.usage.add.viaCredentials': '여기서 사용량 자격 증명 구성',
  'settings.usage.add.viaProviders': '프로바이더 설정에서 연결',
  'settings.usage.add.restoreHint': '이미 구성됨 — 사용량으로 복원',
  'settings.usage.add.openProviders': '프로바이더 설정 열기',
  'settings.usage.add.credentialsTitle': '{provider} 자격 증명',
  'settings.usage.add.viewProvider': '프로바이더 사용량 보기',
  'settings.usage.page.empty.selectProvider': '사용량 세부 정보를 보려면 프로바이더를 선택하세요.',
  'settings.usage.page.backToOverviewAria': '사용량 개요로 돌아가기',
  ...
  'settings.usage.page.actions.removeFromUsage': '사용량에서 제거',
  ...
  'settings.usage.page.section.periodUsage': '이 기간의 사용량',
  'settings.usage.page.section.remainingLimits': '남은 한도',
  ...
  'settings.usage.page.state.noQuotaWindowsDescription': '이 프로바이더는 현재 속도 제한 또는 사용량 할당량을 보고하지 않습니다.',
