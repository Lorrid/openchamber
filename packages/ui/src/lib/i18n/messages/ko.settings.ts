...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.notifications.page.delivery.info': '앱 밖으로 나가는 시스템 알림입니다. 데스크톱은 네이티브 알림을 쓰고, 브라우저나 설치된 앱은 웹 푸시를 쓰므로 탭이 백그라운드여도 도착합니다. 종 아이콘의 기록은 별개입니다.',
  ...
  'settings.notifications.page.inbox.title': '앱 내 기록',
  'settings.notifications.page.inbox.info': '목록을 끄면 모든 행과 배지가 숨겨집니다. 종류 하나만 끄면 그것만 숨깁니다. 행은 저장되어 있으니 다시 켜면 돌아옵니다.',
  'settings.notifications.page.inbox.enableLabel': '앱 내 기록 사용',
  ...
  'settings.notifications.page.inbox.soundInfo': '목록에 항목이 들어오고 이 창이 앞에 있을 때 짧은 소리가 납니다. 같은 스위치가 시스템 배너 소리도 끕니다.',
  ...
  'settings.notifications.page.inbox.sessionErrorAria': '세션 오류를 앱 내 기록에 표시',
  'settings.notifications.page.inbox.sessionSubtaskLabel': '하위 작업',
  'settings.notifications.page.inbox.sessionSubtaskAria': '앱 기록에 하위 작업 알림 표시',
  'settings.notifications.page.inbox.permissionQuestionLabel': '권한과 질문',
  'settings.notifications.page.inbox.permissionQuestionAria': '권한과 질문 알림을 앱 내 기록에 표시',
  'settings.notifications.page.inbox.appErrorWarningLabel': '앱 오류와 경고',
  'settings.notifications.page.inbox.appErrorWarningAria': '앱 오류와 경고를 앱 내 기록에 표시',
  'settings.notifications.page.inbox.infoLabel': '정보',
  'settings.notifications.page.inbox.infoAria': '정보 알림을 앱 내 기록에 표시',
  'settings.notifications.page.inbox.successLabel': '성공',
  'settings.notifications.page.inbox.successAria': '성공 알림을 앱 내 기록에 표시',
