export const settingsDict = {
  ...
  'settings.workspaces.setup.step.apple-container.egress': "외부 프록시",
  ...
  'settings.workspaces.setup.stepInfo.apple-container.egress': "Apple Container에서는 관리형 egress를 사용할 수 없으므로 외부 프록시가 필요합니다.",
  ...
  'settings.workspaces.lifecycle.sourceIsHome': '홈 디렉터리입니다. 워크스페이스는 프로젝트를 컨테이너로 복사하므로, 홈 디렉터리를 복사하면 SSH 키와 클라우드 자격 증명, 셸 기록까지 함께 들어갑니다.',
  'settings.workspaces.lifecycle.sourceIsRoot': '파일 시스템 루트입니다. 워크스페이스는 프로젝트를 컨테이너로 복사하므로, 루트를 복사하면 이 컴퓨터의 모든 계정이 함께 들어갑니다.',
  'settings.workspaces.lifecycle.sourceChooseProject': '대신 프로젝트 디렉터리를 선택하세요.',
  ...
  'settings.workspaces.provider.appleContainerHint': 'Docker Desktop이 없는 macOS 호스트용입니다. 외부 프록시가 필요합니다. 이 플랫폼에서는 관리형 egress를 사용할 수 없습니다.',
