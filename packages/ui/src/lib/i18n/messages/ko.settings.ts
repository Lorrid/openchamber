...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.opencodeCli.field.agentWebTool': 'OpenChamber Web 도구',
  'settings.openchamber.opencodeCli.field.agentWebToolAria': 'OpenChamber Web 도구 활성화',
  'settings.openchamber.opencodeCli.field.agentWebToolInfo': '에이전트가 OpenChamber 브라우저 패널에서 페이지를 확인하고 조작할 수 있습니다. URL 열기, 내용 읽기, 클릭, 입력, 스크롤, 모바일과 데스크톱 레이아웃 전환이 가능합니다. 각 세션에 작은 도구 설명이 추가됩니다. Save + Reload 후 적용됩니다.',
