...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.agentBrowser.title': '에이전트 브라우저',
  'settings.openchamber.agentBrowser.status.loading': '브라우저 확인 중…',
  'settings.openchamber.agentBrowser.status.unknown': '브라우저 상태를 확인할 수 없습니다.',
  'settings.openchamber.agentBrowser.status.ready': '준비됨: {path}',
  'settings.openchamber.agentBrowser.status.missing': '이 호스트에서 Chrome 호환 브라우저를 찾을 수 없습니다.',
  'settings.openchamber.agentBrowser.status.missingPath': '구성된 브라우저 경로가 존재하지 않습니다.',
  'settings.openchamber.agentBrowser.status.host': '호스트: {platform}/{arch}',
  'settings.openchamber.agentBrowser.field.binaryPath': '브라우저 실행 파일',
  'settings.openchamber.agentBrowser.field.binaryPathPlaceholder': '/usr/bin/google-chrome-stable',
  'settings.openchamber.agentBrowser.field.binaryPathInfo': 'Chrome, Chromium, Edge 또는 Brave의 절대 경로입니다. 비워 두면 관리형 설치, OPENCHAMBER_BROWSER_PATH 또는 자동 검색을 사용합니다. 저장 후 적용됩니다.',
  'settings.openchamber.agentBrowser.field.noSandbox': '브라우저 샌드박스 비활성화',
  'settings.openchamber.agentBrowser.field.noSandboxAria': '헤드리스 호스트용 Chromium 샌드박스 비활성화',
  'settings.openchamber.agentBrowser.field.noSandboxInfo': 'Chromium 샌드박스를 사용할 수 없는 많은 헤드리스 서버, 컨테이너, root 환경에서 필요합니다. OPENCHAMBER_BROWSER_NO_SANDBOX=true와 동일합니다.',
  'settings.openchamber.agentBrowser.field.noSandboxRecommended': '이 호스트에서 권장됩니다(컨테이너 또는 root).',
  'settings.openchamber.agentBrowser.actions.browseAria': '브라우저 실행 파일 찾기',
  'settings.openchamber.agentBrowser.actions.save': '저장',
  'settings.openchamber.agentBrowser.actions.saving': '저장 중…',
  'settings.openchamber.agentBrowser.actions.install': 'Chrome 설치',
  'settings.openchamber.agentBrowser.actions.installing': '설치 중…',
  'settings.openchamber.agentBrowser.actions.installUnsupported': '이 플랫폼에서는 관리형 설치를 사용할 수 없습니다.',
