...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.usage.overview.empty.title': '활성 프로바이더 없음',
  'settings.usage.overview.empty.description': '프로바이더를 연결하여 사용량과 남은 한도 추적을 시작하세요.',
  ...
  'settings.usage.add.description': '연결하여 사용량 추적을 시작할 비활성 프로바이더를 선택하세요.',
  'settings.usage.add.backAria': '사용량 개요로 돌아가기',
  'settings.usage.add.empty': '지원되는 모든 프로바이더가 이미 연결되어 있습니다.',
