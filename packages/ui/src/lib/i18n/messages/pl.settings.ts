export const settingsDict = {
  ...
  'settings.workspaces.setup.step.apple-container.egress': "Zewnętrzny serwer proxy",
  ...
  'settings.workspaces.setup.stepInfo.apple-container.egress': "Apple Container wymaga zewnętrznego serwera proxy, ponieważ zarządzany ruch wychodzący jest niedostępny.",
  ...
  'settings.workspaces.lifecycle.sourceIsHome': 'To jest Twój katalog domowy. Workspace kopiuje projekt do kontenera, a skopiowanie katalogu domowego zabrałoby ze sobą Twoje klucze SSH, poświadczenia chmurowe i historię powłoki.',
  'settings.workspaces.lifecycle.sourceIsRoot': 'To jest katalog główny systemu plików. Workspace kopiuje projekt do kontenera, a skopiowanie katalogu głównego zabrałoby ze sobą wszystkie konta na tym komputerze.',
  'settings.workspaces.lifecycle.sourceChooseProject': 'Wybierz zamiast tego katalog projektu.',
  ...
  'settings.workspaces.provider.appleContainerHint': 'Dla hostów macOS bez Docker Desktop. Wymaga zewnętrznego proxy: zarządzane wyjście nie jest dostępne na tej platformie.',
