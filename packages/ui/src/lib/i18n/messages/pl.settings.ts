...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.usage.add.description': 'Wybierz nieaktywnego dostawcę do połączenia i rozpoczęcia śledzenia użycia.',
  'settings.usage.add.empty': 'Wszyscy obsługiwani dostawcy są już połączeni.',
  ...
  'settings.usage.overview.empty.description': 'Połącz dostawcę, aby zacząć śledzić użycie i pozostałe limity.',
  'settings.usage.overview.empty.title': 'Brak aktywnych dostawców',
