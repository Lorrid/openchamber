...
export const settingsDict = {
  ...
  'settings.openchamber.agentBrowser.title': 'Przeglądarka agenta',
  'settings.openchamber.agentBrowser.status.loading': 'Sprawdzanie przeglądarki…',
  'settings.openchamber.agentBrowser.status.unknown': 'Status przeglądarki jest niedostępny.',
  'settings.openchamber.agentBrowser.status.ready': 'Gotowe: {path}',
  'settings.openchamber.agentBrowser.status.missing': 'Na tym hoście nie znaleziono przeglądarki zgodnej z Chrome.',
  'settings.openchamber.agentBrowser.status.missingPath': 'Skonfigurowana ścieżka przeglądarki nie istnieje.',
  'settings.openchamber.agentBrowser.status.host': 'Host: {platform}/{arch}',
  'settings.openchamber.agentBrowser.field.binaryPath': 'Plik wykonywalny przeglądarki',
  'settings.openchamber.agentBrowser.field.binaryPathPlaceholder': '/usr/bin/google-chrome-stable',
  'settings.openchamber.agentBrowser.field.binaryPathInfo': 'Bezwzględna ścieżka do Chrome, Chromium, Edge lub Brave. Pozostaw puste, aby użyć instalacji zarządzanej, OPENCHAMBER_BROWSER_PATH lub automatycznego wykrywania. Obowiązuje po zapisaniu.',
  'settings.openchamber.agentBrowser.field.noSandbox': 'Wyłącz piaskownicę przeglądarki',
  'settings.openchamber.agentBrowser.field.noSandboxAria': 'Wyłącz piaskownicę Chromium na hostach headless',
  'settings.openchamber.agentBrowser.field.noSandboxInfo': 'Wymagane na wielu serwerach headless, w kontenerach i jako root, gdy piaskownica Chromium jest niedostępna. Odpowiednik OPENCHAMBER_BROWSER_NO_SANDBOX=true.',
  'settings.openchamber.agentBrowser.field.noSandboxRecommended': 'Zalecane na tym hoście (kontener lub root).',
  'settings.openchamber.agentBrowser.actions.browseAria': 'Wybierz plik wykonywalny przeglądarki',
  'settings.openchamber.agentBrowser.actions.save': 'Zapisz',
  'settings.openchamber.agentBrowser.actions.saving': 'Zapisywanie…',
  'settings.openchamber.agentBrowser.actions.install': 'Zainstaluj Chrome',
  'settings.openchamber.agentBrowser.actions.installing': 'Instalowanie…',
  'settings.openchamber.agentBrowser.actions.installUnsupported': 'Instalacja zarządzana jest niedostępna na tej platformie.',
