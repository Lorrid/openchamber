...
export const settingsDict = {
  ...
  'settings.notifications.page.delivery.info': 'To alerty systemowe poza aplikacją. Na komputerze są to natywne powiadomienia. W przeglądarce lub zainstalowanej aplikacji to web push, więc dochodzą także gdy karta jest w tle. Dzwonek trzyma osobną listę w aplikacji.',
  ...
  'settings.notifications.page.inbox.title': 'Historia w aplikacji',
  'settings.notifications.page.inbox.info': 'Wyłącz listę, aby ukryć wszystkie wiersze i odznakę. Odznacz rodzaj, aby ukryć tylko ten. Wiersze zostają zapisane, więc ponowne włączenie je przywraca.',
  'settings.notifications.page.inbox.enableLabel': 'Włącz historię w aplikacji',
  ...
  'settings.notifications.page.inbox.soundInfo': 'Krótki dźwięk, gdy pozycja trafia na listę i to okno jest na wierzchu. Ten sam przełącznik wycisza też banery systemowe.',
  ...
  'settings.notifications.page.inbox.sessionErrorAria': 'Pokazuj błędy sesji w historii w aplikacji',
  'settings.notifications.page.inbox.sessionSubtaskLabel': 'Podzadania',
  'settings.notifications.page.inbox.sessionSubtaskAria': 'Pokazuj powiadomienia podzadań w historii aplikacji',
  'settings.notifications.page.inbox.permissionQuestionLabel': 'Uprawnienia i pytania',
  'settings.notifications.page.inbox.permissionQuestionAria': 'Pokazuj powiadomienia o uprawnieniach i pytaniach w historii w aplikacji',
  'settings.notifications.page.inbox.appErrorWarningLabel': 'Błędy i ostrzeżenia aplikacji',
  'settings.notifications.page.inbox.appErrorWarningAria': 'Pokazuj błędy i ostrzeżenia aplikacji w historii w aplikacji',
  'settings.notifications.page.inbox.infoLabel': 'Informacje',
  'settings.notifications.page.inbox.infoAria': 'Pokazuj powiadomienia informacyjne w historii w aplikacji',
  'settings.notifications.page.inbox.successLabel': 'Sukces',
  'settings.notifications.page.inbox.successAria': 'Pokazuj powiadomienia o sukcesie w historii w aplikacji',
