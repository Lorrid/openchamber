export const settingsDict = {
  ...
  'settings.openchamber.opencodeCli.field.agentWebTool': 'Narzędzie OpenChamber Web',
  'settings.openchamber.opencodeCli.field.agentWebToolAria': 'Włącz narzędzie OpenChamber Web',
  'settings.openchamber.opencodeCli.field.agentWebToolInfo': 'Pozwól agentom oglądać stronę w panelu przeglądarki OpenChamber i wchodzić z nią w interakcję: otwierać adres URL, czytać treść, klikać, pisać, przewijać i przełączać między układem mobilnym a desktopowym. Dodaje krótki opis narzędzia do każdej sesji. Zastosowane po Save + Reload.',
