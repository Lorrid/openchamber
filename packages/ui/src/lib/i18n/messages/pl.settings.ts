...
export const settingsDict = {
  ...
  'settings.notifications.page.inbox.info': 'Każdy toast jest zapisywany na tym urządzeniu. Wyłącz rodzaj, aby ukryć go w centrum powiadomień i na odznace. Wiersz zostaje w historii, jeśli włączysz go z powrotem.',
