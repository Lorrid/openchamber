...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.hapi': 'Brama HAPI',
  'settings.remoteInstances.clientAuth.addDevice.transport.hapiHint': 'Używa usługi pośredniczącej HAPI. Ten komputer automatycznie otwiera kanał do bieżącego serwera OpenChamber.',
  'settings.remoteInstances.clientAuth.addDevice.hapi.placeholder': 'https://your-hapi-relay.example.com',
  'settings.remoteInstances.clientAuth.addDevice.hapi.help': 'Podaj adres usługi HAPI. Ten komputer zapamięta go i automatycznie odtworzy kanał.',
  'settings.remoteInstances.clientAuth.addDevice.hapi.invalid': 'Podaj prawidłowy adres usługi HAPI.',
  'settings.remoteInstances.clientAuth.addDevice.hapi.unreachable': 'Nie udało się utworzyć kanału przez tę usługę HAPI.',
