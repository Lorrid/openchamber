...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.usage.add.backAria': 'Powrót do przeglądu użycia',
  'settings.usage.add.credentialsTitle': 'Dane uwierzytelniające {provider}',
  'settings.usage.add.description': 'Wybierz spośród dostępnych dostawców: połącz nowego lub przywróć skonfigurowanego dostawcę usuniętego z Użycia.',
  'settings.usage.add.empty': 'Wszyscy obsługiwani dostawcy są już wyświetlani w Użyciu.',
  'settings.usage.add.openProviders': 'Otwórz ustawienia Dostawców',
  'settings.usage.add.restoreHint': 'Już skonfigurowany — przywróć do Użycia',
  'settings.usage.add.title': 'Dodaj dostawcę',
  'settings.usage.add.viaCredentials': 'Skonfiguruj dane uwierzytelniające użycia tutaj',
  'settings.usage.add.viaProviders': 'Połącz w ustawieniach Dostawców',
  'settings.usage.add.viewProvider': 'Zobacz użycie dostawcy',
  'settings.usage.overview.actions.addProvider': 'Dodaj dostawcę',
  'settings.usage.overview.actions.addProviderDescription': 'Połącz nowego dostawcę LLM',
  'settings.usage.overview.actions.manageLimits': 'Zarządzaj limitami',
  'settings.usage.overview.actions.manageLimitsDescription': 'Przejrzyj pozostałe kwoty i limity',
  'settings.usage.overview.actions.title': 'Szybkie działania',
  'settings.usage.overview.available.connect': 'Połącz',
  'settings.usage.overview.available.description': 'Dostawcy, których możesz połączyć lub przywrócić do bloku Użycie po usunięciu.',
  'settings.usage.overview.available.hiddenConfigured': 'Skonfigurowany — usunięty z Użycia',
  'settings.usage.overview.available.notConfigured': 'Jeszcze nie połączony',
  'settings.usage.overview.available.restore': 'Przywróć',
  'settings.usage.overview.available.title': 'Dostępni dostawcy',
  'settings.usage.overview.chart.empty': 'Brak użycia sesji w tym okresie.',
  'settings.usage.overview.chart.metric.cost': 'Koszt',
  'settings.usage.overview.chart.metric.requests': 'Żądania',
  'settings.usage.overview.chart.metric.tokens': 'Tokeny',
  'settings.usage.overview.chart.metricAria': 'Metryka wykresu',
  'settings.usage.overview.chart.topProviders': 'Najwięksi dostawcy według wydatków',
  'settings.usage.overview.chart.usageOverTime': 'Użycie w czasie',
  'settings.usage.overview.description': 'Monitoruj użycie i koszty LLM u wszystkich dostawców.',
  'settings.usage.overview.empty.description': 'Skonfigurowani dostawcy pojawiają się tutaj automatycznie. Dodaj dostawcę lub przywróć usuniętego.',
  'settings.usage.overview.empty.title': 'Brak dostawców w Użyciu',
  'settings.usage.overview.metric.avgCost': 'Śr. koszt / 1K tokenów',
  'settings.usage.overview.metric.requests': 'Żądania',
  'settings.usage.overview.metric.totalSpend': 'Łączne wydatki',
  'settings.usage.overview.metric.totalTokens': 'Łączna liczba tokenów',
  'settings.usage.overview.period.30d': '30 dni',
  'settings.usage.overview.period.7d': '7 dni',
  'settings.usage.overview.period.aria': 'Okres użycia',
  'settings.usage.overview.providers.col.provider': 'Dostawca',
  'settings.usage.overview.providers.col.remaining': 'Pozostało / Limit',
  'settings.usage.overview.providers.col.requests': 'Żądania',
  'settings.usage.overview.providers.col.spend': 'Wydatki',
  'settings.usage.overview.providers.col.status': 'Status',
  'settings.usage.overview.providers.col.tokens': 'Tokeny',
  'settings.usage.overview.providers.openDetailAria': 'Otwórz szczegóły użycia {provider}',
  'settings.usage.overview.providers.remainingPct': 'Pozostało {percent}%',
  'settings.usage.overview.providers.removeAria': 'Usuń {provider} z Użycia',
  'settings.usage.overview.providers.status.active': 'Aktywny',
  'settings.usage.overview.providers.status.error': 'Błąd',
  'settings.usage.overview.providers.title': 'Dostawcy',
  'settings.usage.overview.title': 'Przegląd użycia',
  ...
  'settings.usage.page.actions.removeFromUsage': 'Usuń z Użycia',
  'settings.usage.page.backToOverviewAria': 'Powrót do przeglądu użycia',
  ...
  'settings.usage.page.section.periodUsage': 'Użycie w tym okresie',
  'settings.usage.page.section.remainingLimits': 'Pozostałe limity',
  ...
  'settings.usage.sidebar.activeProviders': 'Aktywni dostawcy',
  'settings.usage.sidebar.activeTotal': '{count} aktywnych',
  'settings.usage.sidebar.addProvider': 'Dodaj dostawcę',
  'settings.usage.sidebar.availableCount': '{count} dostępnych',
  ...
  'settings.usage.sidebar.overview': 'Przegląd',
  'settings.usage.sidebar.remainingPct': 'Pozostało {percent}%',
  'settings.usage.sidebar.removeProviderAria': 'Usuń {provider} z Użycia',
  'settings.usage.sidebar.removeProviderTitle': 'Usuń z Użycia',
  ...
  'settings.usage.sidebar.usedPct': 'Użyto {percent}%',
