...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.browser.annotate.tool.select': '选择',
  'contextPanel.browser.annotate.tool.region': '区域',
  'contextPanel.browser.annotate.tool.draw': '绘制',
  'contextPanel.browser.annotate.tool.styles': '样式',
  'contextPanel.browser.annotate.commentPlaceholder': '描述所需更改...',
  'contextPanel.browser.annotate.submit': '附加',
  'contextPanel.browser.annotate.cancel': '取消',
  'contextPanel.browser.annotate.clear': '清除',
  'contextPanel.browser.annotate.group.text': '文本',
  'contextPanel.browser.annotate.group.colors': '颜色',
  'contextPanel.browser.annotate.group.borders': '边框',
  'contextPanel.browser.annotate.group.sizing': '尺寸',
  'contextPanel.browser.annotate.field.fontSize': '大小',
  'contextPanel.browser.annotate.field.fontWeight': '字重',
  'contextPanel.browser.annotate.field.textColor': '颜色',
  'contextPanel.browser.annotate.field.background': '填充',
  'contextPanel.browser.annotate.field.borderColor': '颜色',
  'contextPanel.browser.annotate.field.borderWidth': '宽度',
  'contextPanel.browser.annotate.field.borderRadius': '圆角',
  'contextPanel.browser.annotate.field.width': '宽度',
  'contextPanel.browser.annotate.field.height': '高度',
  'contextPanel.browser.annotate.field.opacity': '不透明度',
