...
export const dict: Record<I18nKey, string> = {
  ...
  'desktopHostSwitcher.sshError.openchamberInstall.guidance': '请确认远程能访问 npm 源，然后重试。也可以用 Node 22/24 和 npm 自行安装 @openchambery/web。',
  ...
  'desktopHostSwitcher.sshError.unknown.guidance': '请到「设置 → 远程实例」查看该主机并重试。若持续失败，在远程安装 Node.js 22 或 24 LTS，并先在终端确认 SSH 能登录。',
