...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.branch.unpushedSingle': '1 个未推送提交',
  'gitView.branch.unpushedPlural': '{count} 个未推送提交',
  ...
  'chat.draftDirtyNotice.titleSingle': '此项目有一个未提交的更改',
  'chat.draftDirtyNotice.titlePlural': '此项目有 {count} 个未提交的更改',
  'chat.draftDirtyNotice.description': '新会话将在相同的文件中工作。工作树可为它提供隔离的副本。',
  'chat.draftDirtyNotice.actions.worktree': '在工作树中工作',
  'chat.draftDirtyNotice.actions.dismissAria': '关闭提示',
