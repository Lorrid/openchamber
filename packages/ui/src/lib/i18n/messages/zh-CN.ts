...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.android.switch.menuItem': '切换服务端',
  'mobile.android.switch.title': '切换服务端',
  'mobile.android.switch.connectNew': '连接新的服务端',
  'mobile.android.login.title': '连接 OpenChamber',
  'mobile.android.login.description': '输入 OpenChamber 服务端地址。支持 HTTP 局域网地址。',
  'mobile.android.field.server': '服务端地址',
  'mobile.android.field.serverPlaceholder': 'http://192.168.1.10:3000',
  'mobile.android.field.name': '名称',
  'mobile.android.field.namePlaceholder': '家里电脑',
  'mobile.android.field.password': '密码',
  'mobile.android.field.passwordPlaceholder': '保存在本机用于快速登录',
  'mobile.android.action.connect': '连接',
  'mobile.android.action.connecting': '连接中...',
  'mobile.android.action.cancel': '取消',
  'mobile.android.action.delete': '删除',
  'mobile.android.action.disconnect': '断开并选择服务端',
  'mobile.android.action.chooseServer': '重新选择服务端',
  'mobile.android.current.title': '当前服务端',
  'mobile.android.current.unknown': '已选择的服务端',
  'mobile.android.status.connecting': '连接中...',
  'mobile.android.status.checking': '检查中',
  'mobile.android.status.online': '连接正常',
  'mobile.android.status.offline': '无法连接',
  'mobile.android.health.openAria': '打开服务端健康状态',
  'mobile.android.health.title': '服务端健康状态',
  'mobile.android.health.latency': '延迟',
  'mobile.android.health.latencyValue': '{latency} ms',
  'mobile.android.health.latencyUnknown': '未知',
  'mobile.android.health.lastChecked': '上次检查',
  'mobile.android.health.notChecked': '尚未检查',
  'mobile.android.health.error': '错误',
  'mobile.android.health.refresh': '刷新',
  'mobile.android.health.refreshing': '刷新中...',
  'mobile.android.saved.title': '已保存服务端',
