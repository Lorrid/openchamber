...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.chatInput.pinnedContextSingle': '{count} 项固定内容',
  'chat.chatInput.pinnedContextPlural': '{count} 项固定内容',
  'chat.chatInput.pinnedContextRemove': '取消固定项目上下文',
  'chat.chatInput.pinnedContextTooltip': '固定的项目上下文会随下一条消息一起发送',
  ...
  'rightSidebar.contextNotesTodo.search.placeholder': '搜索笔记、待办和计划',
  ...
  'rightSidebar.contextNotesTodo.memory.unreviewed': '未确认',
  ...
  'rightSidebar.contextNotesTodo.memory.actions.confirm': '确认这条记忆',
  'rightSidebar.contextNotesTodo.memory.actions.delete': '删除这条记忆',
  'rightSidebar.contextNotesTodo.memory.toast.confirmFailed': '确认记忆失败',
