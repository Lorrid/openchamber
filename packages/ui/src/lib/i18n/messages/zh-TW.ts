...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.chatInput.pinnedContextSingle': '{count} 項釘選內容',
  'chat.chatInput.pinnedContextPlural': '{count} 項釘選內容',
  'chat.chatInput.pinnedContextRemove': '取消釘選專案上下文',
  'chat.chatInput.pinnedContextTooltip': '釘選的專案上下文會隨下一則訊息一起送出',
  ...
  'rightSidebar.contextNotesTodo.search.placeholder': '搜尋筆記、待辦與計畫',
  ...
  'rightSidebar.contextNotesTodo.memory.actions.confirm': '確認這則記憶',
  'rightSidebar.contextNotesTodo.memory.actions.delete': '刪除這則記憶',
  'rightSidebar.contextNotesTodo.memory.toast.confirmFailed': '確認記憶失敗',
