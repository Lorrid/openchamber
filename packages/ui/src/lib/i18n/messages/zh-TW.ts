...
export const dict: Record<I18nKey, string> = {
  ...
  'desktopHostSwitcher.sshError.openchamberInstall.guidance': '請確認遠端能存取 npm 來源，然後重試。也可以用 Node 22/24 和 npm 自行安裝 @openchambery/web。',
  ...
  'desktopHostSwitcher.sshError.unknown.guidance': '請到「設定 → 遠端實例」查看該主機並重試。若持續失敗，在遠端安裝 Node.js 22 或 24 LTS，並先在終端機確認 SSH 能登入。',
