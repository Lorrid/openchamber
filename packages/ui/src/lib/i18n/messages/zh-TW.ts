...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.branch.unpushedSingle': '1 個未推送提交',
  'gitView.branch.unpushedPlural': '{count} 個未推送提交',
  ...
  'chat.draftDirtyNotice.titleSingle': '此專案有一個未提交的變更',
  'chat.draftDirtyNotice.titlePlural': '此專案有 {count} 個未提交的變更',
  'chat.draftDirtyNotice.description': '新的工作階段會在相同的檔案中作業。工作樹可提供隔離的副本。',
  'chat.draftDirtyNotice.actions.worktree': '在工作樹中作業',
  'chat.draftDirtyNotice.actions.dismissAria': '關閉提示',
