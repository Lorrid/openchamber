...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.android.switch.menuItem': '切換服務端',
  'mobile.android.switch.title': '切換服務端',
  'mobile.android.switch.connectNew': '連接新的服務端',
  'mobile.android.login.title': '連接 OpenChamber',
  'mobile.android.login.description': '輸入 OpenChamber 服務端地址。支援 HTTP 區域網地址。',
  'mobile.android.field.server': '服務端地址',
  'mobile.android.field.serverPlaceholder': 'http://192.168.1.10:3000',
  'mobile.android.field.name': '名稱',
  'mobile.android.field.namePlaceholder': '家裡電腦',
  'mobile.android.field.password': '密碼',
  'mobile.android.field.passwordPlaceholder': '保存在本機用於快速登入',
  'mobile.android.action.connect': '連接',
  'mobile.android.action.connecting': '連接中...',
  'mobile.android.action.cancel': '取消',
  'mobile.android.action.delete': '刪除',
  'mobile.android.action.disconnect': '斷開並選擇服務端',
  'mobile.android.action.chooseServer': '重新選擇服務端',
  'mobile.android.current.title': '目前服務端',
  'mobile.android.current.unknown': '已選擇的服務端',
  'mobile.android.status.connecting': '連接中...',
  'mobile.android.status.checking': '檢查中',
  'mobile.android.status.online': '連線正常',
  'mobile.android.status.offline': '無法連線',
  'mobile.android.health.openAria': '開啟服務端健康狀態',
  'mobile.android.health.title': '服務端健康狀態',
  'mobile.android.health.latency': '延遲',
  'mobile.android.health.latencyValue': '{latency} ms',
  'mobile.android.health.latencyUnknown': '未知',
  'mobile.android.health.lastChecked': '上次檢查',
  'mobile.android.health.notChecked': '尚未檢查',
  'mobile.android.health.error': '錯誤',
  'mobile.android.health.refresh': '重新整理',
  'mobile.android.health.refreshing': '重新整理中...',
  'mobile.android.saved.title': '已儲存服務端',
