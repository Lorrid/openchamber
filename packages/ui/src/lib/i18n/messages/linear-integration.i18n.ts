...
export const linearIntegrationI18n = {
  en: {
    ...
    'settings.integrations.linear.description': 'Connect a Linear workspace on this OpenChamber server.',
    'settings.integrations.linear.info': 'Connect your Linear workspace. OpenChamber stores the login on this computer so web, desktop, and a paired phone share it.',
  ...
  de: {
    ...
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': 'Verbinde einen Linear-Workspace mit diesem OpenChamber-Server.',
    'settings.integrations.linear.info': 'Verbinde deinen Linear-Workspace. OpenChamber speichert die Anmeldung auf diesem Computer, damit Web, Desktop und ein gekoppeltes Telefon sie teilen.',
  ...
  fr: {
    ...
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': 'Connectez un espace Linear à ce serveur OpenChamber.',
    'settings.integrations.linear.info': 'Connectez votre espace Linear. OpenChamber enregistre la connexion sur cet ordinateur pour que le web, le bureau et un téléphone apparié la partagent.',
  ...
  es: {
    ...
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': 'Conecta un espacio de Linear a este servidor de OpenChamber.',
    'settings.integrations.linear.info': 'Conecta tu espacio de Linear. OpenChamber guarda el inicio de sesión en este ordenador para que la web, el escritorio y un teléfono emparejado lo compartan.',
  ...
  ja: {
    ...
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': 'この OpenChamber サーバーに Linear ワークスペースを接続します。',
    'settings.integrations.linear.info': 'Linear ワークスペースを接続します。ログインはこのコンピュータに保存され、Web、デスクトップ、ペアリングしたスマホで共有されます。',
  ...
  ko: {
    ...
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': '이 OpenChamber 서버에 Linear 워크스페이스를 연결하세요.',
    'settings.integrations.linear.info': 'Linear 워크스페이스를 연결하세요. 로그인은 이 컴퓨터에 저장되며 웹, 데스크톱, 페어링된 휴대폰이 공유합니다.',
  ...
  pl: {
    ...
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': 'Połącz przestrzeń Linear z tym serwerem OpenChamber.',
    'settings.integrations.linear.info': 'Połącz przestrzeń Linear. OpenChamber zapisuje logowanie na tym komputerze, żeby przeglądarka, aplikacja desktopowa i sparowany telefon z niego korzystały.',
  ...
  'pt-BR': {
    ...
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': 'Conecte um espaço do Linear a este servidor OpenChamber.',
    'settings.integrations.linear.info': 'Conecte seu espaço do Linear. O OpenChamber guarda o login neste computador para que a web, o app desktop e um celular emparelhado o compartilhem.',
  ...
  uk: {
    ...
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': 'Підключіть Linear workspace до цього сервера OpenChamber.',
    'settings.integrations.linear.info': 'Підключіть свій Linear workspace. OpenChamber зберігає вхід на цьому комп’ютері, тож веб, десктоп і спарений телефон користуються одним обліковим записом.',
  ...
  'zh-CN': {
    ...
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': '将 Linear 工作区连接到此 OpenChamber 服务器。',
    'settings.integrations.linear.info': '连接你的 Linear 工作区。OpenChamber 把登录保存在这台电脑上，网页、桌面应用和已配对的手机会共用它。',
  ...
  'zh-TW': {
    ...
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': '將 Linear 工作區連線到此 OpenChamber 伺服器。',
    'settings.integrations.linear.info': '連接你的 Linear 工作區。OpenChamber 把登入保存在這台電腦上，網頁、桌面應用程式和已配對的手機會共用它。',
