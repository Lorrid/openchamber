...
export const dict: Record<I18nKey, string> = {
  ...
  "mobile.android.switch.menuItem": "Switch server",
  "mobile.android.switch.title": "Switch server",
  "mobile.android.switch.connectNew": "Connect new server",
  "mobile.android.login.title": "Connect to OpenChamber",
  "mobile.android.login.description": "Enter an OpenChamber server address. HTTP LAN addresses are supported.",
  "mobile.android.field.server": "Server address",
  "mobile.android.field.serverPlaceholder": "http://192.168.1.10:3000",
  "mobile.android.field.name": "Name",
  "mobile.android.field.namePlaceholder": "Home machine",
  "mobile.android.field.password": "Password",
  "mobile.android.field.passwordPlaceholder": "Saved locally for quick login",
  "mobile.android.action.connect": "Connect",
  "mobile.android.action.connecting": "Connecting...",
  "mobile.android.action.cancel": "Cancel",
  "mobile.android.action.delete": "Delete",
  "mobile.android.action.disconnect": "Disconnect and choose server",
  "mobile.android.action.chooseServer": "Choose another server",
  "mobile.android.current.title": "Current server",
  "mobile.android.current.unknown": "Selected server",
  "mobile.android.status.connecting": "Conectando...",
  "mobile.android.status.checking": "Comprobando",
  "mobile.android.status.online": "En línea",
  "mobile.android.status.offline": "Sin conexión",
  "mobile.android.health.openAria": "Abrir estado del servidor",
  "mobile.android.health.title": "Estado del servidor",
  "mobile.android.health.latency": "Latencia",
  "mobile.android.health.latencyValue": "{latency} ms",
  "mobile.android.health.latencyUnknown": "Desconocida",
  "mobile.android.health.lastChecked": "Última comprobación",
  "mobile.android.health.notChecked": "Aún no comprobado",
  "mobile.android.health.error": "Error",
  "mobile.android.health.refresh": "Actualizar",
  "mobile.android.health.refreshing": "Actualizando...",
  "mobile.android.saved.title": "Servidores guardados",
