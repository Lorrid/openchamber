...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.draftDirtyNotice.titleSingle': 'Este proyecto tiene un cambio sin confirmar',
  'chat.draftDirtyNotice.titlePlural': 'Este proyecto tiene {count} cambios sin confirmar',
  'chat.draftDirtyNotice.description': 'Una nueva sesión trabajará en los mismos archivos. Un worktree le da una copia aislada.',
  'chat.draftDirtyNotice.actions.worktree': 'Trabajar en un worktree',
  'chat.draftDirtyNotice.actions.dismissAria': 'Descartar aviso',
