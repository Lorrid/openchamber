...
export const dict: Record<I18nKey, string> = {
  ...
  "desktopHostSwitcher.sshError.openchamberInstall.guidance": "Comprueba que el remoto pueda acceder al registro npm y reintenta. También puedes instalar @openchambery/web tú mismo con Node 22 o 24 y npm.",
  ...
  "desktopHostSwitcher.sshError.unknown.guidance": "Abre Ajustes → Instancias remotas para este host y reintenta. Si sigue fallando, instala Node.js 22 o 24 LTS en el remoto y confirma el login SSH en una terminal.",
