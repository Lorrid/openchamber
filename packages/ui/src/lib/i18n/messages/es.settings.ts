...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.notifications.page.inbox.info": "Cada aviso se guarda en este dispositivo. Desactiva un tipo para ocultarlo del centro de notificaciones y de su distintivo. La fila permanece en el historial si lo vuelves a activar.",
