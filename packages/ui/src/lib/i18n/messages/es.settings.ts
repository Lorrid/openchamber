...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.usage.overview.empty.title": "No hay proveedores activos",
  "settings.usage.overview.empty.description": "Conecta un proveedor para empezar a rastrear el uso y los límites restantes.",
  ...
  "settings.usage.add.description": "Elige un proveedor inactivo para conectar y empezar a rastrear el uso.",
  "settings.usage.add.backAria": "Volver al resumen de uso",
  "settings.usage.add.empty": "Todos los proveedores compatibles ya están conectados.",
