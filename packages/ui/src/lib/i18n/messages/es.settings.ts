...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.usage.sidebar.activeTotal": "{count} activos",
  "settings.usage.sidebar.overview": "Resumen",
  "settings.usage.sidebar.activeProviders": "Proveedores activos",
  "settings.usage.sidebar.addProvider": "Añadir proveedor",
  "settings.usage.sidebar.availableCount": "{count} disponibles",
  "settings.usage.sidebar.removeProviderAria": "Quitar {provider} de Uso",
  "settings.usage.sidebar.removeProviderTitle": "Quitar de Uso",
  ...
  "settings.usage.overview.title": "Resumen de uso",
  "settings.usage.overview.description": "Supervisa el uso y los costes de LLM en todos los proveedores.",
  "settings.usage.overview.period.aria": "Periodo de uso",
  "settings.usage.overview.period.7d": "7 días",
  "settings.usage.overview.period.30d": "30 días",
  "settings.usage.overview.metric.totalSpend": "Gasto total",
  "settings.usage.overview.metric.totalTokens": "Tokens totales",
  "settings.usage.overview.metric.requests": "Solicitudes",
  "settings.usage.overview.metric.avgCost": "Coste medio / 1K tokens",
  "settings.usage.overview.chart.usageOverTime": "Uso a lo largo del tiempo",
  "settings.usage.overview.chart.topProviders": "Principales proveedores por gasto",
  "settings.usage.overview.chart.metricAria": "Métrica del gráfico",
  "settings.usage.overview.chart.metric.tokens": "Tokens",
  "settings.usage.overview.chart.metric.cost": "Coste",
  "settings.usage.overview.chart.metric.requests": "Solicitudes",
  "settings.usage.overview.chart.empty": "Aún no hay uso de sesión en este periodo.",
  "settings.usage.overview.providers.title": "Proveedores",
  "settings.usage.overview.providers.col.provider": "Proveedor",
  "settings.usage.overview.providers.col.spend": "Gasto",
  "settings.usage.overview.providers.col.tokens": "Tokens",
  "settings.usage.overview.providers.col.requests": "Solicitudes",
  "settings.usage.overview.providers.col.remaining": "Restante / Límite",
  "settings.usage.overview.providers.col.status": "Estado",
  "settings.usage.overview.providers.remainingPct": "{percent}% restante",
  "settings.usage.overview.providers.status.active": "Activo",
  "settings.usage.overview.providers.status.error": "Error",
  "settings.usage.overview.providers.openDetailAria": "Abrir detalles de uso de {provider}",
  "settings.usage.overview.providers.removeAria": "Quitar {provider} de Uso",
  "settings.usage.overview.empty.title": "Aún no hay proveedores en Uso",
  "settings.usage.overview.empty.description": "Los proveedores configurados aparecen aquí automáticamente. Añade un proveedor o restaura uno que hayas quitado.",
  "settings.usage.overview.actions.title": "Acciones rápidas",
  "settings.usage.overview.actions.addProvider": "Añadir proveedor",
  "settings.usage.overview.actions.addProviderDescription": "Conectar un nuevo proveedor de LLM",
  "settings.usage.overview.actions.manageLimits": "Gestionar límites",
  "settings.usage.overview.actions.manageLimitsDescription": "Revisar cuotas y límites restantes",
  "settings.usage.overview.available.title": "Proveedores disponibles",
  "settings.usage.overview.available.description": "Proveedores que puedes conectar, o restaurar al bloque de Uso después de quitarlos.",
  "settings.usage.overview.available.hiddenConfigured": "Configurado — quitado de Uso",
  "settings.usage.overview.available.notConfigured": "Aún no conectado",
  "settings.usage.overview.available.restore": "Restaurar",
  "settings.usage.overview.available.connect": "Conectar",
  "settings.usage.add.title": "Añadir proveedor",
  "settings.usage.add.description": "Elige entre los proveedores disponibles: conecta uno nuevo o restaura un proveedor configurado que hayas quitado de Uso.",
  "settings.usage.add.backAria": "Volver al resumen de uso",
  "settings.usage.add.empty": "Todos los proveedores compatibles ya se muestran en Uso.",
  "settings.usage.add.viaCredentials": "Configurar credenciales de uso aquí",
  "settings.usage.add.viaProviders": "Conectar en Ajustes de proveedores",
  "settings.usage.add.restoreHint": "Ya configurado — restaurar a Uso",
  "settings.usage.add.openProviders": "Abrir ajustes de proveedores",
  "settings.usage.add.credentialsTitle": "Credenciales de {provider}",
  "settings.usage.add.viewProvider": "Ver uso del proveedor",
  "settings.usage.page.empty.selectProvider": "Selecciona un proveedor para ver detalles de uso.",
  "settings.usage.page.backToOverviewAria": "Volver al resumen de uso",
  ...
  "settings.usage.page.actions.removeFromUsage": "Quitar de Uso",
  ...
  "settings.usage.page.section.periodUsage": "Uso de este periodo",
  "settings.usage.page.section.remainingLimits": "Límites restantes",
