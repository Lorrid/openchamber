...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.opencodeCli.field.agentWebTool": "Herramienta OpenChamber Web",
  "settings.openchamber.opencodeCli.field.agentWebToolAria": "Activar la herramienta OpenChamber Web",
  "settings.openchamber.opencodeCli.field.agentWebToolInfo": "Permite que los agentes vean la página en el panel de navegador de OpenChamber e interactúen con ella: abrir una URL, leer el contenido, hacer clic, escribir, desplazarse y alternar entre diseño móvil y de escritorio. Añade una pequeña descripción de herramienta a cada sesión. Se aplica tras Save + Reload.",
