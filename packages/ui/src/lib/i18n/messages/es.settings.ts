...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.keyboardShortcuts.action.open_notifications.label": "Abrir notificaciones",
  ...
  "settings.notifications.page.delivery.info": "Son avisos del sistema fuera de la app. En el escritorio son notificaciones nativas. En el navegador o la app instalada son web push, y llegan aunque la pestaña esté en segundo plano. La campana guarda una lista aparte dentro de la app.",
  ...
  "settings.notifications.page.inbox.title": "Historial en la app",
  "settings.notifications.page.inbox.info": "Apaga la lista para ocultar todas las filas y el distintivo. Desactiva un tipo para ocultar solo ese. Las filas siguen guardadas, así que al volver a activarlas reaparecen.",
  "settings.notifications.page.inbox.enableLabel": "Activar el historial en la app",
  ...
  "settings.notifications.page.inbox.soundInfo": "Un tono breve cuando un aviso entra en la lista y esta ventana está al frente. El mismo interruptor también silencia los avisos del sistema.",
  ...
  "settings.notifications.page.inbox.sessionErrorAria": "Mostrar errores de sesión en el historial de la app",
  "settings.notifications.page.inbox.sessionSubtaskLabel": "Subtareas",
  "settings.notifications.page.inbox.sessionSubtaskAria": "Mostrar avisos de subtareas en el historial de la app",
  "settings.notifications.page.inbox.permissionQuestionLabel": "Permisos y preguntas",
  "settings.notifications.page.inbox.permissionQuestionAria": "Mostrar avisos de permiso y preguntas en el historial de la app",
  "settings.notifications.page.inbox.appErrorWarningLabel": "Errores y avisos de la app",
  "settings.notifications.page.inbox.appErrorWarningAria": "Mostrar errores y avisos de la app en el historial de la app",
  "settings.notifications.page.inbox.infoLabel": "Información",
  "settings.notifications.page.inbox.infoAria": "Mostrar avisos informativos en el historial de la app",
  "settings.notifications.page.inbox.successLabel": "Éxito",
  "settings.notifications.page.inbox.successAria": "Mostrar avisos de éxito en el historial de la app",
