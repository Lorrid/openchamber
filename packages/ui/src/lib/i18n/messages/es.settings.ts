...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.agentBrowser.title": "Navegador del agente",
  "settings.openchamber.agentBrowser.status.loading": "Comprobando el navegador…",
  "settings.openchamber.agentBrowser.status.unknown": "El estado del navegador no está disponible.",
  "settings.openchamber.agentBrowser.status.ready": "Listo: {path}",
  "settings.openchamber.agentBrowser.status.missing": "No se encontró un navegador compatible con Chrome en este host.",
  "settings.openchamber.agentBrowser.status.missingPath": "La ruta de navegador configurada no existe.",
  "settings.openchamber.agentBrowser.status.host": "Host: {platform}/{arch}",
  "settings.openchamber.agentBrowser.field.binaryPath": "Ejecutable del navegador",
  "settings.openchamber.agentBrowser.field.binaryPathPlaceholder": "/usr/bin/google-chrome-stable",
  "settings.openchamber.agentBrowser.field.binaryPathInfo": "Ruta absoluta a Chrome, Chromium, Edge o Brave. Déjala vacía para usar la instalación administrada, OPENCHAMBER_BROWSER_PATH o el descubrimiento automático. Se aplica al guardar.",
  "settings.openchamber.agentBrowser.field.noSandbox": "Desactivar el sandbox del navegador",
  "settings.openchamber.agentBrowser.field.noSandboxAria": "Desactivar el sandbox de Chromium en hosts headless",
  "settings.openchamber.agentBrowser.field.noSandboxInfo": "Necesario en muchos servidores headless, contenedores y entornos root donde el sandbox de Chromium no está disponible. Equivale a OPENCHAMBER_BROWSER_NO_SANDBOX=true.",
  "settings.openchamber.agentBrowser.field.noSandboxRecommended": "Recomendado en este host (contenedor o root).",
  "settings.openchamber.agentBrowser.actions.browseAria": "Buscar el ejecutable del navegador",
  "settings.openchamber.agentBrowser.actions.save": "Guardar",
  "settings.openchamber.agentBrowser.actions.saving": "Guardando…",
  ...
  "settings.openchamber.agentBrowser.actions.installUnsupported": "La instalación administrada no está disponible en esta plataforma.",
