...
export const settingsDict = {
  ...
  'settings.notifications.page.inbox.info': 'Every toast is saved on this device. Turn a kind off to hide it from the notification center and its badge. The row stays in history if you turn it back on.',
