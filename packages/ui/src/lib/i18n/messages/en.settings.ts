export const settingsDict = {
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.hapi': 'HAPI gateway',
  'settings.remoteInstances.clientAuth.addDevice.transport.hapiHint': 'Use a HAPI relay service. This PC automatically opens a channel to its local OpenChamber server.',
  'settings.remoteInstances.clientAuth.addDevice.hapi.placeholder': 'https://your-hapi-relay.example.com',
  'settings.remoteInstances.clientAuth.addDevice.hapi.help': 'Enter the HAPI relay service address. This computer remembers it and recreates the channel automatically.',
  'settings.remoteInstances.clientAuth.addDevice.hapi.invalid': 'Enter a valid HAPI relay service address.',
  'settings.remoteInstances.clientAuth.addDevice.hapi.unreachable': 'Could not create a channel through that HAPI relay service.',
