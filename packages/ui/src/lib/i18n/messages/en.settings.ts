export const settingsDict = {
  ...
  'settings.remoteInstances.page.sync.description': 'Mirror your local OpenCode config (~/.config/opencode), agent skills (~/.agents), and provider credentials (auth.json) to this remote so both sides match and logins work. Symlinked folders are copied as real files.',
