export const settingsDict = {
  ...
  'settings.usage.overview.empty.title': 'No active providers',
  'settings.usage.overview.empty.description': 'Connect a provider to start tracking usage and remaining limits.',
  ...
  'settings.usage.add.description': 'Choose an inactive provider to connect and start tracking usage.',
  'settings.usage.add.backAria': 'Back to usage overview',
  'settings.usage.add.empty': 'All supported providers are already connected.',
