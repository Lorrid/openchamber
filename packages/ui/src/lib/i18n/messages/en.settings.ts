export const settingsDict = {
  ...
  'settings.openchamber.opencodeCli.field.agentWebTool': 'OpenChamber Web tool',
  'settings.openchamber.opencodeCli.field.agentWebToolAria': 'Enable the OpenChamber Web tool',
  'settings.openchamber.opencodeCli.field.agentWebToolInfo': 'Let agents look at and interact with the page in OpenChamber\'s browser panel: open a URL, read the page, click, type, scroll, and switch between mobile and desktop layouts. Adds a small tool description to each session. Applies after Save + Reload.',
