...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.keyboardShortcuts.action.open_notifications.label": "Відкрити сповіщення",
  ...
  "settings.notifications.page.inbox.info": "Кожен тост зберігається на цьому пристрої. Вимкніть тип, щоб сховати його з центру сповіщень і значка. Рядок лишається в історії, якщо ви знову ввімкнете його.",
