...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.usage.overview.empty.title": "Немає активних провайдерів",
  "settings.usage.overview.empty.description": "Підключіть провайдера, щоб почати відстежувати використання та залишки лімітів.",
  ...
  "settings.usage.add.description": "Оберіть неактивного провайдера для підключення та початку відстеження використання.",
  "settings.usage.add.backAria": "Назад до огляду використання",
  "settings.usage.add.empty": "Усі підтримувані провайдери вже підключені.",
