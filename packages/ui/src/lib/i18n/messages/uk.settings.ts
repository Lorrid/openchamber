...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.remoteInstances.clientAuth.addDevice.transport.hapi": "Шлюз HAPI",
  "settings.remoteInstances.clientAuth.addDevice.transport.hapiHint": "Використовує службу ретрансляції HAPI. Цей ПК автоматично відкриває канал до поточного сервера OpenChamber.",
  "settings.remoteInstances.clientAuth.addDevice.hapi.placeholder": "https://your-hapi-relay.example.com",
  "settings.remoteInstances.clientAuth.addDevice.hapi.help": "Введіть адресу служби HAPI. Цей комп’ютер запам’ятає її та автоматично відновить канал.",
  "settings.remoteInstances.clientAuth.addDevice.hapi.invalid": "Введіть дійсну адресу служби HAPI.",
  "settings.remoteInstances.clientAuth.addDevice.hapi.unreachable": "Не вдалося створити канал через цю службу HAPI.",
