...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.about.field.clientVersion": "Версія клієнта",
  "settings.openchamber.about.field.instanceOpenChamberVersion": "Версія OpenChamber екземпляра",
  "settings.openchamber.about.field.instanceOpenCodeVersion": "Версія OpenCode екземпляра",
