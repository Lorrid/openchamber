...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.branch.unpushedSingle': '未プッシュのコミット 1 件',
  'gitView.branch.unpushedPlural': '未プッシュのコミット {count} 件',
  ...
  'chat.draftDirtyNotice.titleSingle': 'このプロジェクトには未コミットの変更があります',
  'chat.draftDirtyNotice.titlePlural': 'このプロジェクトには{count}件の未コミットの変更があります',
  'chat.draftDirtyNotice.description': '新しいセッションは同じファイルで作業します。ワークツリーなら独立したコピーで作業できます。',
  'chat.draftDirtyNotice.actions.worktree': 'ワークツリーで作業',
  'chat.draftDirtyNotice.actions.dismissAria': '通知を閉じる',
