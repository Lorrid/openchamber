...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.chatInput.pinnedContextSingle': 'ピン留め {count} 件',
  'chat.chatInput.pinnedContextPlural': 'ピン留め {count} 件',
  'chat.chatInput.pinnedContextRemove': 'プロジェクトの文脈のピン留めを解除',
  'chat.chatInput.pinnedContextTooltip': 'ピン留めしたプロジェクトの文脈は次のメッセージと一緒に送られます',
  ...
  'rightSidebar.contextNotesTodo.search.placeholder': 'ノート・Todo・計画を検索',
  ...
  'rightSidebar.contextNotesTodo.memory.unreviewed': '未確認',
  ...
  'rightSidebar.contextNotesTodo.memory.actions.confirm': 'この項目を確認済みにする',
  'rightSidebar.contextNotesTodo.memory.actions.delete': 'この項目を削除',
  'rightSidebar.contextNotesTodo.memory.toast.confirmFailed': '項目を確認できませんでした',
