...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.browser.annotate.tool.styles': 'スタイル',
  'contextPanel.browser.annotate.commentPlaceholder': '変更内容を記述...',
  'contextPanel.browser.annotate.submit': '添付',
  'contextPanel.browser.annotate.cancel': 'キャンセル',
  'contextPanel.browser.annotate.clear': 'クリア',
  'contextPanel.browser.annotate.group.text': 'テキスト',
  'contextPanel.browser.annotate.group.colors': '色',
  'contextPanel.browser.annotate.group.borders': '境界線',
  'contextPanel.browser.annotate.group.sizing': 'サイズ',
  'contextPanel.browser.annotate.field.fontSize': 'サイズ',
  'contextPanel.browser.annotate.field.fontWeight': '太さ',
  'contextPanel.browser.annotate.field.textColor': '色',
  'contextPanel.browser.annotate.field.background': '塗り',
  'contextPanel.browser.annotate.field.borderColor': '色',
  'contextPanel.browser.annotate.field.borderWidth': '幅',
  'contextPanel.browser.annotate.field.borderRadius': '角丸',
  'contextPanel.browser.annotate.field.width': '幅',
  'contextPanel.browser.annotate.field.height': '高さ',
