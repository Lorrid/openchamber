...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.notifications.page.inbox.info": "Cada aviso é salvo neste dispositivo. Desative um tipo para ocultá-lo do centro de notificações e do distintivo. A linha permanece no histórico se você ligar de novo.",
