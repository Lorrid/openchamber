...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.usage.overview.empty.title": "Nenhum provedor ativo",
  "settings.usage.overview.empty.description": "Conecte um provedor para começar a acompanhar o uso e os limites restantes.",
  ...
  "settings.usage.add.description": "Escolha um provedor inativo para conectar e começar a acompanhar o uso.",
  "settings.usage.add.backAria": "Voltar à visão geral de uso",
  "settings.usage.add.empty": "Todos os provedores compatíveis já estão conectados.",
