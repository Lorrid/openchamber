...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.opencodeCli.field.agentWebTool": "Ferramenta OpenChamber Web",
  "settings.openchamber.opencodeCli.field.agentWebToolAria": "Ativar a ferramenta OpenChamber Web",
  "settings.openchamber.opencodeCli.field.agentWebToolInfo": "Permita que agentes vejam a página no painel de navegador do OpenChamber e interajam com ela: abrir uma URL, ler o conteúdo, clicar, digitar, rolar e alternar entre layout móvel e desktop. Adiciona uma pequena descrição de ferramenta a cada sessão. Aplicado após Save + Reload.",
