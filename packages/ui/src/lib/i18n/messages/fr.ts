...
export const dict = {
  ...
  'chat.draftDirtyNotice.titleSingle': 'Ce projet a une modification non commitée',
  'chat.draftDirtyNotice.titlePlural': 'Ce projet a {count} modifications non commitées',
  'chat.draftDirtyNotice.description': 'Une nouvelle session travaillera dans les mêmes fichiers. Un worktree lui donne une copie isolée.',
  'chat.draftDirtyNotice.actions.worktree': 'Travailler dans un worktree',
  'chat.draftDirtyNotice.actions.dismissAria': 'Fermer l’avis',
