...
export const dict = {
  ...
  'projectActions.toast.multipleServers': '{count} serveurs trouvés — choisissez-en un dans le panneau navigateur',
  ...
  'contextPanel.browser.annotate.tool.styles': 'Styles',
  'contextPanel.browser.annotate.commentPlaceholder': 'Décrivez le changement...',
  'contextPanel.browser.annotate.submit': 'Joindre',
  'contextPanel.browser.annotate.cancel': 'Annuler',
  'contextPanel.browser.annotate.clear': 'Effacer',
  'contextPanel.browser.annotate.group.text': 'Texte',
  'contextPanel.browser.annotate.group.colors': 'Couleurs',
  'contextPanel.browser.annotate.group.borders': 'Bordures',
  'contextPanel.browser.annotate.group.sizing': 'Taille',
  'contextPanel.browser.annotate.field.fontSize': 'Taille',
  'contextPanel.browser.annotate.field.fontWeight': 'Graisse',
  'contextPanel.browser.annotate.field.textColor': 'Couleur',
  'contextPanel.browser.annotate.field.background': 'Remplissage',
  'contextPanel.browser.annotate.field.borderColor': 'Couleur',
  'contextPanel.browser.annotate.field.borderWidth': 'Épaisseur',
  'contextPanel.browser.annotate.field.borderRadius': 'Rayon',
  'contextPanel.browser.annotate.field.width': 'Largeur',
  'contextPanel.browser.annotate.field.height': 'Hauteur',
  'contextPanel.browser.annotate.field.opacity': 'Opacité',
