...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.agentBrowser.title': '代理浏览器',
  'settings.openchamber.agentBrowser.status.loading': '正在检查浏览器…',
  'settings.openchamber.agentBrowser.status.unknown': '无法获取浏览器状态。',
  'settings.openchamber.agentBrowser.status.ready': '已就绪：{path}',
  'settings.openchamber.agentBrowser.status.missing': '在此主机上未找到兼容 Chrome 的浏览器。',
  'settings.openchamber.agentBrowser.status.missingPath': '配置的浏览器路径不存在。',
  'settings.openchamber.agentBrowser.status.host': '主机：{platform}/{arch}',
  'settings.openchamber.agentBrowser.field.binaryPath': '浏览器可执行文件',
  'settings.openchamber.agentBrowser.field.binaryPathPlaceholder': '/usr/bin/google-chrome-stable',
  'settings.openchamber.agentBrowser.field.binaryPathInfo': 'Chrome、Chromium、Edge 或 Brave 的绝对路径。留空则使用托管安装、OPENCHAMBER_BROWSER_PATH 或自动发现。保存后生效。',
  'settings.openchamber.agentBrowser.field.noSandbox': '禁用浏览器沙箱',
  'settings.openchamber.agentBrowser.field.noSandboxAria': '在无头主机上禁用 Chromium 沙箱',
  'settings.openchamber.agentBrowser.field.noSandboxInfo': '在许多无头服务器、容器和 root 环境中，若 Chromium 沙箱不可用则需要开启。等同于 OPENCHAMBER_BROWSER_NO_SANDBOX=true。',
  'settings.openchamber.agentBrowser.field.noSandboxRecommended': '建议在此主机上启用（容器或 root）。',
  'settings.openchamber.agentBrowser.actions.browseAria': '浏览浏览器可执行文件',
  'settings.openchamber.agentBrowser.actions.save': '保存',
  'settings.openchamber.agentBrowser.actions.saving': '正在保存…',
  'settings.openchamber.agentBrowser.actions.install': '安装 Chrome',
  'settings.openchamber.agentBrowser.actions.installing': '正在安装…',
  'settings.openchamber.agentBrowser.actions.installUnsupported': '此平台不支持托管安装。',
