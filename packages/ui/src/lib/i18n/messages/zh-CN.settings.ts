...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.usage.sidebar.activeTotal': '{count} 个活跃',
  'settings.usage.sidebar.overview': '概览',
  'settings.usage.sidebar.activeProviders': '活跃提供商',
  'settings.usage.sidebar.addProvider': '添加提供商',
  'settings.usage.sidebar.availableCount': '{count} 个可用',
  'settings.usage.sidebar.removeProviderAria': '从用量中移除 {provider}',
  'settings.usage.sidebar.removeProviderTitle': '从用量中移除',
  'settings.usage.sidebar.remainingPct': '剩余 {percent}%',
  ...
  'settings.usage.overview.title': '用量概览',
  'settings.usage.overview.description': '监控所有提供商的 LLM 用量与成本。',
  'settings.usage.overview.period.aria': '用量周期',
  'settings.usage.overview.period.7d': '7 天',
  'settings.usage.overview.period.30d': '30 天',
  'settings.usage.overview.metric.totalSpend': '总支出',
  'settings.usage.overview.metric.totalTokens': '总 Token 数',
  'settings.usage.overview.metric.requests': '请求数',
  'settings.usage.overview.metric.avgCost': '平均成本 / 1K Tokens',
  'settings.usage.overview.chart.usageOverTime': '用量随时间变化',
  'settings.usage.overview.chart.topProviders': '按支出排名的提供商',
  'settings.usage.overview.chart.metricAria': '图表指标',
  'settings.usage.overview.chart.metric.tokens': 'Tokens',
  'settings.usage.overview.chart.metric.cost': '成本',
  'settings.usage.overview.chart.metric.requests': '请求数',
  'settings.usage.overview.chart.empty': '此周期内尚无会话用量。',
  'settings.usage.overview.providers.title': '提供商',
  'settings.usage.overview.providers.col.provider': '提供商',
  'settings.usage.overview.providers.col.spend': '支出',
  'settings.usage.overview.providers.col.tokens': 'Tokens',
  'settings.usage.overview.providers.col.requests': '请求数',
  'settings.usage.overview.providers.col.remaining': '剩余 / 限额',
  'settings.usage.overview.providers.col.status': '状态',
  'settings.usage.overview.providers.remainingPct': '剩余 {percent}%',
  'settings.usage.overview.providers.status.active': '活跃',
  'settings.usage.overview.providers.status.error': '错误',
  'settings.usage.overview.providers.openDetailAria': '打开 {provider} 用量详情',
  'settings.usage.overview.providers.removeAria': '从用量中移除 {provider}',
  'settings.usage.overview.empty.title': '用量中尚无提供商',
  'settings.usage.overview.empty.description': '已配置的提供商会自动显示在此处。添加提供商，或还原你已移除的提供商。',
  'settings.usage.overview.actions.title': '快捷操作',
  'settings.usage.overview.actions.addProvider': '添加提供商',
  'settings.usage.overview.actions.addProviderDescription': '连接新的 LLM 提供商',
  'settings.usage.overview.actions.manageLimits': '管理限额',
  'settings.usage.overview.actions.manageLimitsDescription': '查看剩余配额与限额',
  'settings.usage.overview.available.title': '可用提供商',
  'settings.usage.overview.available.description': '你可以连接的提供商，或在移除后还原到用量区块的提供商。',
  'settings.usage.overview.available.hiddenConfigured': '已配置 — 已从用量中移除',
  'settings.usage.overview.available.notConfigured': '尚未连接',
  'settings.usage.overview.available.restore': '还原',
  'settings.usage.overview.available.connect': '连接',
  'settings.usage.add.title': '添加提供商',
  'settings.usage.add.description': '从可用提供商中选择：连接新提供商，或还原你从用量中移除的已配置提供商。',
  'settings.usage.add.backAria': '返回用量概览',
  'settings.usage.add.empty': '所有支持的提供商均已显示在用量中。',
  'settings.usage.add.viaCredentials': '在此配置用量凭据',
  'settings.usage.add.viaProviders': '在提供商设置中连接',
  'settings.usage.add.restoreHint': '已配置 — 还原到用量',
  'settings.usage.add.openProviders': '打开提供商设置',
  'settings.usage.add.credentialsTitle': '{provider} 凭据',
  'settings.usage.add.viewProvider': '查看提供商用量',
  'settings.usage.page.empty.selectProvider': '选择一个提供商以查看用量详情。',
  'settings.usage.page.backToOverviewAria': '返回用量概览',
  ...
  'settings.usage.page.actions.removeFromUsage': '从用量中移除',
  ...
  'settings.usage.page.section.periodUsage': '本周期用量',
  'settings.usage.page.section.remainingLimits': '剩余限额',
