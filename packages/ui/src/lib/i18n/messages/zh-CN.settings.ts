export const settingsDict = {
  ...
  'settings.workspaces.setup.step.apple-container.egress': "外部代理",
  ...
  'settings.workspaces.setup.stepInfo.apple-container.egress': "Apple Container 需要外部代理，因为此平台不支持受管出站。",
  ...
  'settings.workspaces.lifecycle.sourceIsHome': '这是你的主目录。工作区会把项目复制到容器中，复制主目录会连同你的 SSH 密钥、云凭据和 shell 历史一起带进去。',
  'settings.workspaces.lifecycle.sourceIsRoot': '这是文件系统根目录。工作区会把项目复制到容器中，复制根目录会连同这台机器上的所有账户一起带进去。',
  'settings.workspaces.lifecycle.sourceChooseProject': '请改为选择一个项目目录。',
  ...
  'settings.workspaces.provider.appleContainerHint': '适用于没有 Docker Desktop 的 macOS 主机。需要外部代理：此平台不支持受管出站。',
