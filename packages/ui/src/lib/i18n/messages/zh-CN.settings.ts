...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.keyboardShortcuts.action.open_notifications.label': '打开通知',
  ...
  'settings.notifications.page.delivery.info': '这是发到应用外的系统通知。桌面端用系统原生通知。浏览器或已安装应用用网页推送，标签页在后台也能收到。铃铛里的记录是另一份列表。',
  ...
  'settings.notifications.page.inbox.title': '应用内记录',
  'settings.notifications.page.inbox.info': '关掉整个列表会隐藏所有行和角标。取消某一类只隐藏那一类。条目仍保存在本机，重新打开就会回来。',
  'settings.notifications.page.inbox.enableLabel': '启用应用内记录',
  ...
  'settings.notifications.page.inbox.soundInfo': '条目进入列表且此窗口在前台时会响一声。同一个开关也会关掉系统横幅的声音。',
  ...
  'settings.notifications.page.inbox.sessionErrorAria': '在应用内记录中显示会话错误',
  'settings.notifications.page.inbox.sessionSubtaskLabel': '子任务',
  'settings.notifications.page.inbox.sessionSubtaskAria': '在应用内历史中显示子任务通知',
  'settings.notifications.page.inbox.permissionQuestionLabel': '许可与提问',
  'settings.notifications.page.inbox.permissionQuestionAria': '在应用内记录中显示许可与提问通知',
  'settings.notifications.page.inbox.appErrorWarningLabel': '应用错误与警告',
  'settings.notifications.page.inbox.appErrorWarningAria': '在应用内记录中显示应用错误与警告',
  'settings.notifications.page.inbox.infoLabel': '信息',
  'settings.notifications.page.inbox.infoAria': '在应用内记录中显示信息通知',
  'settings.notifications.page.inbox.successLabel': '成功',
  'settings.notifications.page.inbox.successAria': '在应用内记录中显示成功通知',
