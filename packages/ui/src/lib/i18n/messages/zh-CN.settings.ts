...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.opencodeCli.field.agentWebToolAria': '启用 OpenChamber Web 工具',
  'settings.openchamber.opencodeCli.field.agentWebToolInfo': '让智能体在 OpenChamber 浏览器面板中查看并操作页面：打开网址、读取内容、点击、输入、滚动，以及在移动端与桌面端布局之间切换。会为每个会话添加少量工具说明。在 Save + Reload 后生效。',
