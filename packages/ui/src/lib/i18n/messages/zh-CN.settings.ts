...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.usage.overview.empty.title': '暂无活跃提供商',
  'settings.usage.overview.empty.description': '连接提供商以开始跟踪用量和剩余限额。',
  ...
  'settings.usage.add.description': '选择一个未启用的提供商进行连接并开始跟踪用量。',
  'settings.usage.add.backAria': '返回用量概览',
  'settings.usage.add.empty': '所有支持的提供商均已连接。',
