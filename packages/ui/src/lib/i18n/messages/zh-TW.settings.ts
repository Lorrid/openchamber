...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.opencodeCli.field.agentWebTool': 'OpenChamber Web 工具',
  'settings.openchamber.opencodeCli.field.agentWebToolAria': '啟用 OpenChamber Web 工具',
  'settings.openchamber.opencodeCli.field.agentWebToolInfo': '讓代理在 OpenChamber 瀏覽器面板中檢視並操作頁面：開啟網址、讀取內容、點擊、輸入、捲動，以及在行動版與桌面版版面之間切換。會為每個工作階段加入少量工具說明。在 Save + Reload 後生效。',
