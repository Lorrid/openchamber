...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.notifications.page.delivery.info': '這是傳到應用程式外的系統通知。桌面端用系統原生通知。瀏覽器或已安裝應用程式用網頁推播，分頁在背景也能收到。鈴鐺裡的紀錄是另一份清單。',
  ...
  'settings.notifications.page.inbox.title': '應用程式內紀錄',
  'settings.notifications.page.inbox.info': '關掉整個清單會隱藏所有列與角標。取消某一類只隱藏那一類。項目仍存在這台裝置，重新打開就會回來。',
  'settings.notifications.page.inbox.enableLabel': '啟用應用程式內紀錄',
  ...
  'settings.notifications.page.inbox.soundInfo': '項目進入清單時會響一聲，此視窗在背景時也會響。系統橫幅已經出聲時則保持安靜。',
  ...
  'settings.notifications.page.inbox.sessionErrorAria': '在應用程式內紀錄中顯示工作階段錯誤',
  'settings.notifications.page.inbox.sessionSubtaskLabel': '子工作',
  'settings.notifications.page.inbox.sessionSubtaskAria': '在應用程式歷史中顯示子工作通知',
  'settings.notifications.page.inbox.permissionQuestionLabel': '許可與提問',
  'settings.notifications.page.inbox.permissionQuestionAria': '在應用程式內紀錄中顯示許可與提問通知',
  'settings.notifications.page.inbox.appErrorWarningLabel': '應用程式錯誤與警告',
  'settings.notifications.page.inbox.appErrorWarningAria': '在應用程式內紀錄中顯示應用程式錯誤與警告',
  'settings.notifications.page.inbox.infoLabel': '資訊',
  'settings.notifications.page.inbox.infoAria': '在應用程式內紀錄中顯示資訊通知',
  'settings.notifications.page.inbox.successLabel': '成功',
  'settings.notifications.page.inbox.successAria': '在應用程式內紀錄中顯示成功通知',
