...
export const dict: Record<I18nKey, string> = {
  ...
  'dockerInstances.title': 'Instâncias Docker',
  'dockerInstances.description': 'Crie e gerencie instâncias do OpenCode em contêineres Docker nesta máquina.',
  'dockerInstances.state.creating': 'Criando',
  'dockerInstances.state.starting': 'Iniciando',
  'dockerInstances.state.probing': 'Aguardando prontidão',
  'dockerInstances.state.running': 'Em execução',
  'dockerInstances.state.stopped': 'Parada',
  'dockerInstances.state.error': 'Erro',
  'dockerInstances.state.removing': 'Removendo',
  'dockerInstances.state.removalFailed': 'Falha na limpeza',
  'dockerInstances.state.empty': 'Nenhuma instância Docker ainda.',
  'dockerInstances.state.loadFailed': 'Não foi possível carregar as instâncias Docker.',
  'dockerInstances.actions.addDocker': 'Adicionar instância Docker',
  'dockerInstances.actions.switchAria': 'Alternar para {name}',
  'dockerInstances.actions.stop': 'Parar',
  'dockerInstances.actions.start': 'Iniciar',
  'dockerInstances.actions.cleanup': 'Repetir limpeza',
  'dockerInstances.actions.remove': 'Remover',
  'dockerInstances.actions.confirmRemove': 'Confirmar remoção',
  'dockerInstances.actions.openAria': 'Abrir instâncias Docker',
  'dockerInstances.create.title': 'Nova instância Docker',
  'dockerInstances.create.description': 'O OpenChamber cria um contêiner, inicia o OpenCode dentro dele e aguarda a prontidão.',
  'dockerInstances.create.field.label': 'Nome',
  'dockerInstances.create.field.labelPlaceholder': 'Nome de exibição opcional',
  'dockerInstances.create.field.image': 'Imagem',
  'dockerInstances.create.field.workspace': 'Caminho do workspace',
  ...
  'dockerInstances.create.sharing.credentialsTitle': 'Compartilhar credenciais',
  'dockerInstances.create.sharing.credentialsHint': 'Somente leitura, desativado por padrão. Os dados de login dos provedores ficam visíveis no contêiner.',
  'dockerInstances.create.sharing.neverShared': 'Nunca compartilhados: socket do Docker, chaves SSH, credenciais do git. As portas se vinculam apenas a esta máquina.',
  'dockerInstances.create.actions.buildImage': 'Compilar {image}',
  'dockerInstances.create.actions.cancel': 'Cancelar',
  'dockerInstances.create.actions.create': 'Criar instância',
  'dockerInstances.create.actions.creating': 'Criando…',
  'dockerInstances.create.error.generic': 'Não foi possível criar a instância.',
  'dockerInstances.create.toast.created': 'Instância Docker criada.',
  'dockerInstances.create.toast.imageBuilt': 'A imagem {image} está pronta.',
  'dockerInstances.toast.activated': 'Alternado para {name}.',
  'dockerInstances.toast.deactivated': 'De volta à instância local.',
