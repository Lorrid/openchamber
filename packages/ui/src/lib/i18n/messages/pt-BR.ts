...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.branch.unpushedSingle': '1 commit não enviado',
  'gitView.branch.unpushedPlural': '{count} commits não enviados',
  ...
  'chat.draftDirtyNotice.titleSingle': 'Este projeto tem uma alteração sem commit',
  'chat.draftDirtyNotice.titlePlural': 'Este projeto tem {count} alterações sem commit',
  'chat.draftDirtyNotice.description': 'Uma nova sessão trabalhará nos mesmos arquivos. Um worktree dá a ela uma cópia isolada.',
  'chat.draftDirtyNotice.actions.worktree': 'Trabalhar em um worktree',
  'chat.draftDirtyNotice.actions.dismissAria': 'Dispensar aviso',
