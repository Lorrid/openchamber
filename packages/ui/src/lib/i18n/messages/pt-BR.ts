...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "desktopHostSwitcher.sshError.openchamberInstall.guidance": "Verifique se o remoto alcança o registro npm e tente de novo. Você também pode instalar @openchambery/web com Node 22 ou 24 e npm.",
  ...
  "desktopHostSwitcher.sshError.unknown.guidance": "Abra Configurações → Instâncias remotas neste host e tente de novo. Se continuar falhando, instale o Node.js 22 ou 24 LTS no remoto e confirme o login SSH no terminal.",
