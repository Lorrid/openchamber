...
export const dict: Record<I18nKey, string> = {
  ...
  "helpDialog.item.openNotifications": "Abrir notificações",
  ...
  "commandPalette.item.openNotifications": "Abrir notificações",
  ...
  'layout.notifications.openAria': 'Notificações',
  'layout.notifications.openTitle': 'Notificações',
  'layout.notifications.title': 'Notificações',
  'layout.notifications.empty': 'Ainda não há notificações',
  'layout.notifications.emptyFiltered': 'Nada corresponde aos filtros atuais',
  'layout.notifications.markAllRead': 'Marcar tudo como lido',
  'layout.notifications.clearAll': 'Limpar tudo',
  'layout.notifications.remove': 'Remover notificação',
  'layout.notifications.sessionSubtaskFinished': 'Subtarefa concluída',
  'layout.notifications.sessionSubtaskError': 'Erro da subtarefa',
  'layout.notifications.openSettings': 'Configurações de notificação',
  'layout.notifications.unreadCountAria': '{count} notificações não lidas',
  'layout.notifications.sessionFinished': 'Sessão concluída',
  'layout.notifications.sessionError': 'Erro da sessão',
  'layout.notifications.permissionNeeded': 'Permissão necessária',
  'layout.notifications.permissionFallback': 'O agente precisa da sua aprovação',
  'layout.notifications.inputNeeded': 'Resposta necessária',
  'layout.notifications.questionFallback': 'O agente está esperando sua resposta',
  'layout.notifications.openSession': 'Abrir sessão',
  'layout.notifications.occurrenceCount': '×{count}',
  'layout.notifications.time.justNow': 'Agora',
