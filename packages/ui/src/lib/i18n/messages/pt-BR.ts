...
export const dict: Record<I18nKey, string> = {
  ...settingsDict,
  'contextPanel.mode.agentBrowser': 'Navegador do agente',
  'contextRail.surface.agentBrowser.description': 'Navegador ao vivo controlado pelo agente',
  'agentBrowser.viewport.desktop': 'Desktop',
  'agentBrowser.viewport.laptop': 'Notebook',
  'agentBrowser.viewport.tablet': 'Tablet',
  'agentBrowser.viewport.mobile': 'Celular',
  'agentBrowser.actions.newTab': 'Nova aba',
  'agentBrowser.actions.reload': 'Recarregar',
  'agentBrowser.actions.go': 'Ir',
  'agentBrowser.actions.screenshot': 'Capturar captura de tela',
  'agentBrowser.actions.startRecording': 'Iniciar gravação',
  'agentBrowser.actions.stopRecording': 'Parar gravação',
  'agentBrowser.recording.active': 'Gravando',
  'agentBrowser.urlBar.placeholder': 'Digite uma URL para abrir',
  'agentBrowser.tab.untitled': 'Nova aba',
  'agentBrowser.tab.close': 'Fechar aba',
  'agentBrowser.preview.aria': 'Pré-visualização do navegador ao vivo',
  'agentBrowser.preview.waitingFrame': 'Aguardando o primeiro quadro…',
  'agentBrowser.preview.connecting': 'Conectando ao navegador…',
  'agentBrowser.empty.noTabs': 'Nenhuma aba aberta',
