...
export const linearPanelI18n = {
  en: {
    ...
    'contextPanel.linear.filter.status.open': 'Open',
    'contextPanel.linear.filter.status.completed': 'Completed',
  ...
  de: {
    ...
    'contextPanel.linear.filter.status.open': 'Offen',
  ...
  fr: {
    ...
    'contextPanel.linear.filter.status.open': 'Ouverts',
    'contextPanel.linear.filter.status.completed': 'Terminés',
  ...
  es: {
    ...
    'contextPanel.linear.filter.status.open': 'Abiertos',
    'contextPanel.linear.filter.status.completed': 'Completados',
  ...
  ja: {
    ...
    'contextPanel.linear.filter.status.open': '未完了',
  ...
  ko: {
    ...
    'contextPanel.linear.filter.status.open': '진행 중',
    'contextPanel.linear.filter.status.completed': '완료됨',
  ...
  pl: {
    ...
    'contextPanel.linear.filter.status.open': 'Otwarte',
  ...
  'pt-BR': {
    ...
    'contextPanel.linear.filter.status.open': 'Abertas',
    'contextPanel.linear.filter.status.completed': 'Concluídas',
  ...
  uk: {
    ...
    'contextPanel.linear.filter.status.open': 'Відкриті',
    'contextPanel.linear.filter.status.completed': 'Завершені',
  ...
  'zh-CN': {
    ...
    'contextPanel.linear.filter.status.open': '未完成',
