...
export const dict: Record<I18nKey, string> = {
  ...
  "desktopHostSwitcher.sshError.openchamberInstall.guidance": "Перевірте, що віддалений хост досягає реєстру npm, і повторіть спробу. Можна також самостійно встановити @openchambery/web за допомогою Node 22 або 24 і npm.",
  ...
  "desktopHostSwitcher.sshError.unknown.guidance": "Відкрийте Параметри → Віддалені інстанси для цього хоста й повторіть спробу. Якщо помилка повторюється, встановіть Node.js 22 або 24 LTS віддалено й перевірте вхід SSH у терміналі.",
