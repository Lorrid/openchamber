...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.chatInput.pinnedContextSingle': '{count} закріплений елемент',
  'chat.chatInput.pinnedContextPlural': '{count} закріплених елементів',
  'chat.chatInput.pinnedContextRemove': 'Відкріпити контекст проєкту',
  'chat.chatInput.pinnedContextTooltip': 'Закріплений контекст проєкту піде разом з наступним повідомленням',
  ...
  "rightSidebar.contextNotesTodo.search.placeholder": "Пошук у нотатках, todo та планах",
  ...
  "rightSidebar.contextNotesTodo.memory.unreviewed": "не переглянуто",
  ...
  "rightSidebar.contextNotesTodo.memory.actions.confirm": "Підтвердити цей запис",
  "rightSidebar.contextNotesTodo.memory.actions.delete": "Забути цей запис",
  "rightSidebar.contextNotesTodo.memory.toast.confirmFailed": "Не вдалося підтвердити запис",
