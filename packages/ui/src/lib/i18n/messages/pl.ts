...
export const dict: Record<I18nKey, string> = {
  ...
  'desktopHostSwitcher.sshError.openchamberInstall.guidance': 'Sprawdź, czy host zdalny ma dostęp do rejestru npm, i spróbuj ponownie. Możesz też samodzielnie zainstalować @openchambery/web z Node 22 lub 24 i npm.',
  ...
  'desktopHostSwitcher.sshError.unknown.guidance': 'Otwórz Ustawienia → Instancje zdalne dla tego hosta i spróbuj ponownie. Jeśli problem się powtarza, zainstaluj Node.js 22 lub 24 LTS zdalnie i potwierdź logowanie SSH w terminalu.',
