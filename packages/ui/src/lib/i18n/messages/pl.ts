...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.draftDirtyNotice.titleSingle': 'Ten projekt ma niezacommitowaną zmianę',
  'chat.draftDirtyNotice.titlePlural': 'Ten projekt ma {count} niezacommitowanych zmian',
  'chat.draftDirtyNotice.description': 'Nowa sesja będzie pracować na tych samych plikach. Worktree daje jej odizolowaną kopię.',
  'chat.draftDirtyNotice.actions.worktree': 'Pracuj w worktree',
  'chat.draftDirtyNotice.actions.dismissAria': 'Zamknij powiadomienie',
  ...
  'gitView.branch.unpushedPlural': '{count} niewypchniętych commitów',
