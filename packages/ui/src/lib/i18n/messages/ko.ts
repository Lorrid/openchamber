...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.browser.annotate.tool.styles': '스타일',
  'contextPanel.browser.annotate.commentPlaceholder': '변경 사항을 설명하세요...',
  'contextPanel.browser.annotate.submit': '첨부',
  'contextPanel.browser.annotate.cancel': '취소',
  'contextPanel.browser.annotate.clear': '지우기',
  'contextPanel.browser.annotate.group.text': '텍스트',
  'contextPanel.browser.annotate.group.colors': '색상',
  'contextPanel.browser.annotate.group.borders': '테두리',
  'contextPanel.browser.annotate.group.sizing': '크기',
  'contextPanel.browser.annotate.field.fontSize': '크기',
  'contextPanel.browser.annotate.field.fontWeight': '굵기',
  'contextPanel.browser.annotate.field.textColor': '색상',
  'contextPanel.browser.annotate.field.background': '채우기',
  'contextPanel.browser.annotate.field.borderColor': '색상',
  'contextPanel.browser.annotate.field.borderWidth': '두께',
  'contextPanel.browser.annotate.field.borderRadius': '반경',
  'contextPanel.browser.annotate.field.width': '너비',
  'contextPanel.browser.annotate.field.height': '높이',
  'contextPanel.browser.annotate.field.opacity': '불투명도',
