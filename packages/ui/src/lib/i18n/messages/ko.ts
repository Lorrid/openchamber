...
export const dict: Record<I18nKey, string> = {
  ...
  'desktopHostSwitcher.sshError.openchamberInstall.guidance': '원격에서 npm 레지스트리에 접근할 수 있는지 확인한 뒤 다시 시도하세요. Node 22/24와 npm으로 @openchambery/web을 직접 설치할 수도 있습니다.',
  ...
  'desktopHostSwitcher.sshError.unknown.guidance': '설정 → 원격 인스턴스에서 이 호스트를 연 뒤 다시 시도하세요. 계속 실패하면 원격에 Node.js 22 또는 24 LTS를 설치하고 터미널에서 SSH 로그인이 되는지 확인하세요.',
