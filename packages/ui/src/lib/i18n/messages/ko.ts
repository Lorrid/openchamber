...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.draftDirtyNotice.titleSingle': '이 프로젝트에 커밋되지 않은 변경 사항이 있습니다',
  'chat.draftDirtyNotice.titlePlural': '이 프로젝트에 커밋되지 않은 변경 사항이 {count}개 있습니다',
  'chat.draftDirtyNotice.description': '새 세션은 같은 파일에서 작업합니다. 워크트리를 사용하면 격리된 사본에서 작업합니다.',
  'chat.draftDirtyNotice.actions.worktree': '워크트리에서 작업',
  'chat.draftDirtyNotice.actions.dismissAria': '알림 닫기',
