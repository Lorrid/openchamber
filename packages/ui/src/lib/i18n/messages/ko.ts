...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.android.status.connecting': '연결 중...',
  'mobile.android.status.checking': '확인 중',
  'mobile.android.status.online': '온라인',
  'mobile.android.status.offline': '오프라인',
  'mobile.android.health.openAria': '서버 상태 열기',
  'mobile.android.health.title': '서버 상태',
  'mobile.android.health.latency': '지연 시간',
  'mobile.android.health.latencyValue': '{latency} ms',
  'mobile.android.health.latencyUnknown': '알 수 없음',
  'mobile.android.health.lastChecked': '마지막 확인',
  'mobile.android.health.notChecked': '아직 확인하지 않음',
  'mobile.android.health.error': '오류',
  'mobile.android.health.refresh': '새로고침',
  'mobile.android.health.refreshing': '새로고침 중...',
  'mobile.android.saved.title': '저장된 서버',
