...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.chatInput.pinnedContextSingle': '고정 항목 {count}개',
  'chat.chatInput.pinnedContextPlural': '고정 항목 {count}개',
  'chat.chatInput.pinnedContextRemove': '프로젝트 컨텍스트 고정 해제',
  'chat.chatInput.pinnedContextTooltip': '고정한 프로젝트 컨텍스트가 다음 메시지와 함께 전송됩니다',
  ...
  'rightSidebar.contextNotesTodo.search.placeholder': '노트, 할 일, 계획 검색',
  ...
  'rightSidebar.contextNotesTodo.memory.unreviewed': '미확인',
  ...
  'rightSidebar.contextNotesTodo.memory.actions.confirm': '이 항목 확인',
  'rightSidebar.contextNotesTodo.memory.actions.delete': '이 항목 삭제',
  'rightSidebar.contextNotesTodo.memory.toast.confirmFailed': '항목을 확인하지 못했습니다',
