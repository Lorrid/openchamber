...
export const dict = {
  ...
  'helpDialog.item.openNotifications': 'Open notifications',
  ...
  'commandPalette.item.openNotifications': 'Open notifications',
  ...
  'layout.notifications.emptyFiltered': 'Nothing matches the current filters',
  'layout.notifications.markAllRead': 'Mark all as read',
  'layout.notifications.clearAll': 'Clear all',
  'layout.notifications.remove': 'Remove notification',
  'layout.notifications.sessionSubtaskFinished': 'Subtask finished',
  'layout.notifications.sessionSubtaskError': 'Subtask error',
  'layout.notifications.openSettings': 'Notification settings',
  'layout.notifications.unreadCountAria': '{count} unread notifications',
  'layout.notifications.sessionFinished': 'Session finished',
  'layout.notifications.sessionError': 'Session error',
  'layout.notifications.permissionNeeded': 'Permission needed',
  'layout.notifications.permissionFallback': 'The agent needs your approval',
  'layout.notifications.inputNeeded': 'Input needed',
  'layout.notifications.questionFallback': 'The agent is waiting for your response',
  'layout.notifications.openSession': 'Open session',
  'layout.notifications.occurrenceCount': '×{count}',
  'layout.notifications.time.justNow': 'Just now',
  'layout.notifications.time.minutesAgo': '{count}m',
