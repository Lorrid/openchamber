...
export const dict = {
  ...
  'dockerInstances.title': 'Docker instances',
  'dockerInstances.description': 'Create and manage OpenCode instances running in Docker containers on this machine.',
  'dockerInstances.state.creating': 'Creating',
  'dockerInstances.state.starting': 'Starting',
  'dockerInstances.state.probing': 'Waiting for readiness',
  'dockerInstances.state.running': 'Running',
  'dockerInstances.state.stopped': 'Stopped',
  'dockerInstances.state.error': 'Error',
  'dockerInstances.state.removing': 'Removing',
  'dockerInstances.state.removalFailed': 'Cleanup failed',
  'dockerInstances.state.empty': 'No Docker instances yet.',
  'dockerInstances.state.loadFailed': 'Docker instances could not be loaded.',
  'dockerInstances.actions.addDocker': 'Add Docker instance',
  'dockerInstances.actions.switchAria': 'Switch to {name}',
  'dockerInstances.actions.stop': 'Stop',
  'dockerInstances.actions.start': 'Start',
  'dockerInstances.actions.cleanup': 'Retry cleanup',
  'dockerInstances.actions.remove': 'Remove',
  'dockerInstances.actions.confirmRemove': 'Confirm remove',
  'dockerInstances.actions.openAria': 'Open Docker instances',
  'dockerInstances.create.title': 'New Docker instance',
  'dockerInstances.create.description': 'OpenChamber creates a container, starts OpenCode inside it and waits until it is ready.',
  'dockerInstances.create.field.label': 'Name',
  'dockerInstances.create.field.labelPlaceholder': 'Optional display name',
  'dockerInstances.create.field.image': 'Image',
  'dockerInstances.create.field.workspace': 'Workspace path',
  ...
  'dockerInstances.create.sharing.credentialsTitle': 'Share credentials',
  'dockerInstances.create.sharing.credentialsHint': 'Read-only, off by default. Provider sign-in data becomes visible inside the container.',
  'dockerInstances.create.sharing.neverShared': 'Never shared: Docker socket, SSH keys, git credentials. Ports bind to this machine only.',
  'dockerInstances.create.actions.buildImage': 'Build {image}',
  'dockerInstances.create.actions.cancel': 'Cancel',
  'dockerInstances.create.actions.create': 'Create instance',
  'dockerInstances.create.actions.creating': 'Creating…',
  'dockerInstances.create.error.generic': 'The instance could not be created.',
  'dockerInstances.create.toast.created': 'Docker instance created.',
  'dockerInstances.create.toast.imageBuilt': 'Image {image} is ready.',
  'dockerInstances.toast.activated': 'Switched to {name}.',
  'dockerInstances.toast.deactivated': 'Back to the local instance.',
