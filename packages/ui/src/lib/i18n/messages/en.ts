...
export const dict = {
  ...
  'gitView.branch.unpushedSingle': '1 unpushed commit',
  'gitView.branch.unpushedPlural': '{count} unpushed commits',
  ...
  'chat.draftDirtyNotice.titleSingle': 'This project has an uncommitted change',
  'chat.draftDirtyNotice.titlePlural': 'This project has {count} uncommitted changes',
  'chat.draftDirtyNotice.description': 'A new session will work in the same files. A worktree gives it an isolated copy.',
  'chat.draftDirtyNotice.actions.worktree': 'Work in a worktree',
  'chat.draftDirtyNotice.actions.dismissAria': 'Dismiss notice',
