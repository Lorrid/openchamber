...
export const dict = {
  ...
  'mobile.android.status.connecting': 'Connecting...',
  'mobile.android.status.checking': 'Checking',
  'mobile.android.status.online': 'Online',
  'mobile.android.status.offline': 'Offline',
  'mobile.android.health.openAria': 'Open server health',
  'mobile.android.health.title': 'Server health',
  'mobile.android.health.latency': 'Latency',
  'mobile.android.health.latencyValue': '{latency} ms',
  'mobile.android.health.latencyUnknown': 'Unknown',
  'mobile.android.health.lastChecked': 'Last checked',
  'mobile.android.health.notChecked': 'Not checked yet',
  'mobile.android.health.error': 'Error',
  'mobile.android.health.refresh': 'Refresh',
  'mobile.android.health.refreshing': 'Refreshing...',
  'mobile.android.saved.title': 'Saved servers',
