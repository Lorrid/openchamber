...
export const dict = {
  ...
  'desktopHostSwitcher.sshError.openchamberInstall.guidance': 'Check that the remote host can reach the npm registry, then retry. You can also install @openchambery/web yourself with Node 22 or 24 and npm.',
  ...
  'desktopHostSwitcher.sshError.unknown.guidance': 'Open Settings → Remote instances for this host and retry. If it keeps failing, install Node.js 22 or 24 LTS on the remote and confirm SSH login works in a terminal.',
