...
export const dict = {
  ...
  'agentBrowser.actions.newTab': 'New tab',
  'agentBrowser.actions.reload': 'Reload',
  'agentBrowser.actions.go': 'Go',
  'agentBrowser.actions.screenshot': 'Capture screenshot',
  'agentBrowser.actions.startRecording': 'Start recording',
  'agentBrowser.actions.stopRecording': 'Stop recording',
  'agentBrowser.recording.active': 'Recording',
  'agentBrowser.urlBar.placeholder': 'Enter a URL to open',
  'agentBrowser.tab.untitled': 'New tab',
  'agentBrowser.tab.close': 'Close tab',
  'agentBrowser.preview.aria': 'Live browser preview',
  'agentBrowser.preview.waitingFrame': 'Waiting for the first frame…',
  'agentBrowser.preview.connecting': 'Connecting to the browser…',
  'agentBrowser.empty.noTabs': 'No open tabs',
  'agentBrowser.empty.title': 'No browser tab open',
  'agentBrowser.empty.description': 'Open a tab to let the agent navigate and interact with a web app while you watch.',
  'agentBrowser.unsupported.title': 'Browser surface unavailable',
  'agentBrowser.unsupported.description': 'No Chrome-compatible browser was found on the server. Install Chrome from Settings → Agent Browser, set a path, or use OPENCHAMBER_BROWSER_PATH.',
  'agentBrowser.artifacts.title': 'Captures',
  'agentBrowser.artifacts.screenshot': 'Screenshot',
  'agentBrowser.artifacts.recording': 'Recording',
  ...
  'contextRail.surface.agentBrowser.description': 'Live browser the agent drives',
