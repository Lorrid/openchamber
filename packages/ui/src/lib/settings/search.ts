...
const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  ...
  {
    id: 'general.agent-browser-status',
    page: 'general',
    titleKey: 'settings.openchamber.agentBrowser.title',
    keywords: ['browser', 'chrome', 'chromium', 'agent browser', 'headless', 'arm64'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'general.agent-browser-path',
    page: 'general',
    titleKey: 'settings.openchamber.agentBrowser.field.binaryPath',
    descriptionKey: 'settings.openchamber.agentBrowser.field.binaryPathInfo',
    keywords: ['browser', 'chrome', 'chromium', 'path', 'executable', 'OPENCHAMBER_BROWSER_PATH'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'general.agent-browser-no-sandbox',
    page: 'general',
    titleKey: 'settings.openchamber.agentBrowser.field.noSandbox',
    descriptionKey: 'settings.openchamber.agentBrowser.field.noSandboxInfo',
    keywords: ['browser', 'sandbox', 'headless', 'docker', 'container', 'no-sandbox'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
