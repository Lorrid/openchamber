...
Escreva o que quer no campo de comentário e pressione **Anexar**. Sua mensagem ganha um cartão com tudo o que você marcou, as mudanças de estilo pedidas e uma captura da página visível com suas marcações desenhadas nela — assim você pode dizer "este botão, um pouco mais arredondado" em vez de descrever onde ele está.
