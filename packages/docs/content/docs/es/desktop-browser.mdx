...
Con un elemento seleccionado, abre **Estilos** para cambiar tamaño y grosor del texto, colores, bordes, tamaño y opacidad. Los cambios se aplican sobre la página real para que los veas, y OpenChamber registra qué has cambiado y desde qué valor.
