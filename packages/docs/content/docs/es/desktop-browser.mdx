...
Escribe lo que quieres en el cuadro de comentario y pulsa **Adjuntar**. Tu mensaje recibe una tarjeta con todo lo que has marcado, los cambios de estilo que pides y una captura de la página visible con tus marcas dibujadas encima — así puedes decir "este botón, un poco más redondeado" en vez de describir dónde está.
