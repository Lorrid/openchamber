...
Die Glocke in der Kopfzeile behält auf diesem Gerät eine lokale Liste von Toasts und Sitzungsereignissen. Verschwindet ein Toast, bevor du ihn antippst, bleibt er im Center ungelesen. Eine Zeile öffnen oder OK bzw. Kopieren antippen markiert sie als gelesen. Die Zeile bleibt, bis du sie entfernst oder sie veraltet. "Alle als gelesen markieren" blendet auch noch sichtbare Toasts aus. Ein Tastaturkürzel öffnet die Liste.

Ein Klick auf eine System- oder Push-Benachrichtigung öffnet diese Sitzung, wenn eine Session-ID dabei ist.

Unter Einstellungen → OpenChamber → Benachrichtigungen gibt es den Abschnitt Verlauf in der App. Schalte eine Art aus, um sie in der Liste und am Badge auszublenden. Die Einträge bleiben gespeichert, ein erneutes Einschalten bringt sie zurück. Info, Erfolg und Unteraufgaben sind standardmäßig aus, damit das Badge nicht vollläuft. Systembanner für Unteraufgaben bleiben am eigenen Schalter unter Ereignisse.
