...
Schreib dein Anliegen ins Kommentarfeld und drücke **Anhängen**. Deine Chat-Nachricht bekommt eine Karte mit allem Markierten, den gewünschten Stiländerungen und einem Screenshot der sichtbaren Seite mit deinen Markierungen darauf — du kannst also „dieser Button, etwas runder" sagen, statt zu beschreiben, wo er steht.
