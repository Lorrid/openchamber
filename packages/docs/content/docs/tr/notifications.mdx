...
Başlıktaki zil, bu cihazda toast’ların ve oturum olaylarının yerel bir listesini tutar. Bir toast’a dokunmadan kaybolursa merkezde okunmamış kalır. Bir satırı açmak, Tamam veya Kopyala’ya basmak onu okundu işaretler. Satır sen silene veya eskıyene kadar durur. Tümünü okundu işaretlemek görünen toast’ları da kapatır. Klavye kısayolu listeyi açar.

Sistem veya push bildirimine tıklamak, oturum kimliği varsa o oturumu açar.

Settings → OpenChamber → Notifications içinde Uygulama içi geçmiş bölümü vardır. Bir türün işaretini kaldırırsan listeden ve rozetten gizlenir. Satırlar kayıtlı kalır, yeniden açınca geri gelir. Bilgi, başarı ve alt görevler başta kapalıdır, rozet dolmasın diye. Alt görev sistem banner’ları Olaylar’daki ayrı anahtarda kalır.
