...
Voyez [Panneau navigateur](/desktop-browser/) pour désigner des éléments, dessiner sur la page, essayer des changements de style et envoyer le tout dans la discussion.
